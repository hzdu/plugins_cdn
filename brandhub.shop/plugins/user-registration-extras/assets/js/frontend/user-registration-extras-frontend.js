...
(function ($) {
	...
	$(document).on(
		...
		function () {
			...
			swal.fire({
				title: title,
				html: user_registration_extras_frontend_data.delete_account_popup_html,
				confirmButtonText:
					...
					return new Promise(function (resolve) {
						...
						if ("prompt_password" === delete_account_option) {
							...
							if (!password) {
								...
								data = {
									action: "user_registration_extras_delete_account",
									password: password,
								};
							}
						} else {
						...
						if ("" !== data) {
							$.ajax({
								url: user_registration_extras_frontend_data.ajax_url,
								method: "POST",
								data: data,
								...
								if (response.success) {
									Swal.fire({
										icon: "success",
										title: user_registration_extras_frontend_data.account_deleted_message,
										customClass:
	...
	$(document).on("click", ".ur-reset-button", function (e) {
		e.preventDefault();
		Swal.fire({
			html: user_registration_extras_frontend_data.clear_button_text,
			icon: "warning",
