!(function (t, n) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? define("ImageComparison", [], n)
        : "object" == typeof exports
        ? (exports.ImageComparison = n())
        : (t.ImageComparison = n());
})(window, function () {
    return (function (t) {
        var n = {};
            ...
            o("inspectSource", function (t) {
                ...
                (t.exports = function (t, n, e, o) {
                    var s = !!o && !!o.unsafe,
                        u = !!o && !!o.enumerable,
                        f = !!o && !!o.noTargetGet;
                    "function" == typeof e && ("string" != typeof n || c(e, "name") || i(e, "name", n), (l(e).source = d.join("string" == typeof n ? n : ""))),
        ...
        function (t, n, e) {
            ...
            t.exports = function (t, n, e, f, p, m, b) {
                ...
                if (
                    (C && ((x = i(C.call(new t()))), v !== Object.prototype && x.next && (l || i(x) === v || (c ? c(x, v) : "function" != typeof x[g] && s(x, g, y)), a(x, _, !0, !0), l && (d[_] = y))),
                    "values" == p &&
                        j &&
                        "values" !== j.name &&
                        ((E = !0),
                    ...
                    if (((w = { values: O("values"), keys: m ? A : O("keys"), entries: O("entries") }), b)) for (S in w) (!h && !E && S in L) || u(L, S, w[S]);
        ...
        function (t, n, e) {
            ...
            var r = e(4),
                ...
                it = function (t, n, e) {
                    t === G && it($, n, e), d(t);
                    var r = h(n, !0);
                    return d(e), u(J, r) ? (e.enumerable ? (u(t, N) && t[N][r] && (t[N][r] = !1), (e = y(e, { enumerable: g(0, !1) }))) : (u(t, N) || q(t, N, g(1, {})), (t[N][r] = !0)), et(t, r, e)) : q(t, r, e);
                },
                ct = function (t, n) {
                    d(t);
                    var e = v(n),
        ...
        function (t, n, e) {
            ...
            t.exports = function (t) {
                var n,
                    ...
                    m = 0,
                    b = u(p);
                if ((y && (g = r(g, h > 2 ? arguments[2] : void 0, 2)), null == b || (v == Array && c(b)))) for (e = new v((n = a(p.length))); n > m; m++) s(e, m, y ? g(p[m], m) : p[m]);
                    ...
                    (e = [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.el.addEventListener("mousedown", function (n) {
                                    t._activate(!0), document.body.classList.add("max-ic-body"), h(t.el), t._slideCompare(n);
                                }),
                                    ...
                                    document.body.addEventListener("mouseup", function () {
                                        document.body.classList.remove("max-ic-body"), g(t.el), t._activate(!1);
                                    }),
                                    this.control.addEventListener("touchstart", function (n) {
                                        t._activate(!0), document.body.classList.add("max-ic-body"), h(t.el);
                                    }),
                                    this.el.addEventListener("touchmove", function (n) {
                                        t.active && t._slideCompare(n);
                                    }),
                                    this.el.addEventListener("touchend", function () {
                                        t._activate(!1), document.body.classList.remove("max-ic-body"), g(t.el);
                                    }),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                n.classList.add("max-ic-label", "max-ic-label-before", "keep"),
                                    e.classList.add("max-ic-label", "max-ic-label-after", "keep"),
                                    ...
                                    this.el.classList.add("max-ic", this.settings.verticalMode ? "max-ic-vertical" : "max-ic-horizontal", this.settings.fluidMode ? "max-ic-is-fluid" : "max-ic-standard"),
                                    t.classList.add("max-ic-imposter"),
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                r.classList.add("max-ic-theme-wrapper");
								var c = document.createElement("div"),
									a = '<span class="max-ic-arrow max-ic-arrow-left"/></span><span class="max-ic-arrow max-ic-arrow-right"/></span>';
                                ...
                                this.arrowAnimator.forEach(function (n, e) {
                                    n.classList.add("max-ic-arrow-wrapper")
                                }),
                                    n.classList.add("max-ic-control"),
                                    (n.style.cssText = "\n    "
                                    ...
                                    e.classList.add("max-ic-control-line"),
                                    (e.style.cssText = "\n      "
                                        .concat(this.settings.controlShadow ? "box-shadow: 0px 0px 15px rgba(0,0,0,0.33);" : "", "\n    "));
                                var u = e.cloneNode(!0);
                                o.classList.add("max-ic-circle"),
                                    (o.style.cssText = "\n\n      "
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                for (var r = 0; r <= 1; r++) {
                                    var o = e[r];
                                    if ((o.classList.add("max-ic-img"), o.classList.add(0 === r ? "max-ic-img-before" : "max-ic-img-after"), 1 === r)) {
                                        var i = document.createElement("div"),
                                            c = e[1].src;
                                        i.classList.add("max-ic-wrapper"),
                                            (i.style.cssText = "\n            width: "
                                ...
                                if (this.settings.fluidMode) {
                                    ...
                                    s.classList.add("max-ic-fluidwrapper"), (s.style.cssText = "\n \n        background-image: url(".concat(a, ");\n        \n      ")), this.el.appendChild(s);
                                }
                            },
                        },
                    ]) && m(n.prototype, e),
...
function mabImageComparison() {
	bricksQuerySelectorAll(document, ".bricks-element-max-image-comparison, .brxe-max-image-comparison").forEach(function (e) {
        var settings = JSON.parse(e.dataset.settings),
            view     = new ImageComparison(e, settings).mount();
	});
}
