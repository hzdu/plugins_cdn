...
(function ($) {
    ...
    $.pandalocker.lang.defaults = {
        ...
        errors: {
            ...
            unableToLoadSDK:
                'Unable to load SDK script for "{0}" due to the error "{1}". Please make sure that nothing blocks loading of social scripts in your browser. Some browser extentions (Avast, PrivDog, AdBlock etc.) or usage of private tabs in FireFox may cause this issue. Turn them off and try again.',
            ...
            invlidFacebookAppId:
                "Invalid App ID or given URL is not allowed by the Application configuration: One or more of the given URLs is not allowed by the App's settings.  It must match the Website URL or Canvas URL, or the domain must be a subdomain of one of the App's domains.",
...
!(function (a) {
    "use strict";
    a.pandalocker || (a.pandalocker = {}),
    a.pandalocker.data || (a.pandalocker.data = {}),
    a.pandalocker.entity || (a.pandalocker.entity = {}),
    a.pandalocker.groups || (a.pandalocker.groups = {}),
    a.pandalocker.controls || (a.pandalocker.controls = {}),
    a.pandalocker.tools || (a.pandalocker.tools = {}),
    a.pandalocker.storages || (a.pandalocker.storages = {}),
    a.pandalocker.services || (a.pandalocker.services = {}),
    a.pandalocker.extras || (a.pandalocker.extras = {}),
    a.pandalocker.controls["social-buttons"] || (a.pandalocker.controls["social-buttons"] = {}),
    a.pandalocker.controls["connect-buttons"] || (a.pandalocker.controls["connect-buttons"] = {}),
    a.pandalocker.controls.subscription || (a.pandalocker.controls.subscription = {});
})(jQuery);
/*!
 * Filers & Hooks API
 * Copyright 2014, OnePress, http://byonepress.com
...
!(function (a) {
    "use strict";
    a.pandalocker || (a.pandalocker = {}),
        (a.pandalocker.filters = a.pandalocker.filters || {
            _items: {},
            _priorities: {},
            run: function (a, b) {
            ...
            add: function (b, c, d) {
                d || (d = 10),
                this._items[b] || (this._items[b] = {}),
                this._items[b][d] || (this._items[b][d] = []),
                    this._items[b][d].push(c),
                this._priorities[b] || (this._priorities[b] = []),
                -1 === a.inArray(d, this._priorities[b]) && this._priorities[b].push(d),
                    this._priorities[b].sort(function (a, b) {
                        return a - b;
                    });
            },
        }),
...
!(function (a, b, c) {
    "use strict";
    c.pandalocker || (c.pandalocker = {}),
        (c.pandalocker.deferred =
            c.Deferred ||
            function () {
                var a = { done: [], fail: [], always: [] };
                (this.resolved = !1),
                    (this.rejected = !1),
                    (this.arg1 = null),
                    (this.arg2 = null),
...
!(function (a) {
    "use strict";
    a.pandalocker.tools || (a.pandalocker.tools = {}),
        (a.pandalocker.tools.extend = function (b) {
            function c() {}
        ...
        (a.pandalocker.widget = function (b, c) {
            var d = {
                createWidget: function (d, e) {
                    var f = a.extend(!0, {}, c);
                    (f.element = a(d)), (f.options = a.extend(!0, f.options, e)), f._init && f._init(), f._create && f._create(), a.data(d, "plugin_" + b, f);
                },
        ...
        a.pandalocker.detectBrowser(),
        (a.pandalocker.tools.camelCase = function (a) {
        ...
        (a.pandalocker.tools.saveValue = function (b, c, d) {
            if (localStorage && localStorage.setItem)
                try {
                    ...
                    a.pandalocker.tools.cookie(b, c, { expires: d, path: "/" });
                }
            else a.pandalocker.tools.cookie(b, c, { expires: d, path: "/" });
        }),
...
!(function (a) {
    ...
    a.pandalocker.sdk = a.pandalocker.sdk || {
        ...
        connect: function (b, c, d) {
            ...
            if (
                (a(document).bind(b + "-init", function () {
                    g.resolve();
                }),
                    a(document).bind(b + "-error", function (a, c) {
                        (e._error[b] = !0), g.reject(c);
                    }),
                this._connected[b] && !e._error[b])
            )
                return g.promise();
            f.createEvents ||
            (f.createEvents = function () {
                var b = f.isLoaded(),
                    c = function () {
                ...
                return b
                    ? void c()
                    : void a(document).bind(f.name + "-script-loaded", function () {
                        c();
                    });
            }),
            f.prepare && f.prepare();
            ...
            if (
                ...
                this._connected[b] || f.createEvents(),
                !i || e._error[b])
            ) {
                if (e._error[b]) {
            ...
            (b.prototype = {
                ...
                queryString: function (a) {
                    ...
                    var b,
                        c,
                        d = this._url[y];
                    if (d) for (b = 0, c = d.length; c > b; b++) (a += d[b].join(o)), c - 1 > b && (a += p);
                    return a;
                },
                fragment: function (a) {
                    ...
                    return this.isValid() && a.isValid()
                        ? a.isAbsolute()
                            ? this.isAbsolute()
                                ? a.scheme()
                                    ? a
                                    : new b(a).scheme(this.scheme())
                                : a
                            : ((c = new b(this.isAbsolute() ? this : null)),
                                a.path()
                                    ? ((d = a.isHostRelative() || !this.path() ? a.path() : this.path().substring(0, this.path().lastIndexOf(k) + 1) + a.path()), c.path(this._normalizePath(d)).query(a.query()).fragment(a.fragment()))
                                    : a.query()
                                        ? c.query(a.query()).fragment(a.fragment())
                                        : a.fragment() && c.fragment(a.fragment()),
                                c)
                        : this;
                },
                reduce: function (a) {
                ...
                _parse: function (b, c) {
                    ...
                    switch ((c || ((c = b.match(A)), (c = c ? (c[1] ? e : c[2] ? f : null) : null)), c)) {
                        case e:
                            ...
                            ((h = {}),
                                (h[s] = e),
                                (h[t] = g[1] ? g[1].toLowerCase() : void 0),
                                (h[u] = g[2]),
                                (h[v] = g[3].toLowerCase()),
                                (h[w] = g[4] ? parseInt(g[4], 10) : void 0),
                                (h[x] = g[5] || k),
                                (h[y] = this._parseQuery(g[6])),
                                (h[z] = g[7]));
                            break;
                        case f:
    ...
    var d = { filterId: 0 },
        ...
        h = function (e, h) {
            var i,
                j,
                k,
                l = { intensity: 5, forceSVGUrl: !1, animationOptions: { duration: 1e3, easing: "linear" } },
                m = c.extend(l, h),
                n = {},
                o = function (a) {
                    if (n[a] || "" === n[a]) return n[a] + a;
                    for (var c = b.createElement("div"), d = ["", "Moz", "Webkit", "O", "ms", "Khtml"], e = 0; e < d.length; e++) if ("undefined" != typeof c.style[d[e] + a]) return (n[a] = d[e]), d[e] + a;
                    return a.toLowerCase();
                },
                p = { cssfilters: f(), svgfilters: g() },
                q = !1,
                r = o("Filter"),
                s = function (a) {
                ...
                t = function () {
                    ...
                    (i = s("feGaussianBlur")),
                        ...
                        b.setAttribute("id", "blur-effect-id-" + d.filterId),
                        b.appendChild(i),
                        a.appendChild(b),
                        c("body").append(a);
                };
            return (
                (this.$elm = e instanceof c ? e : c(e)),
                    ...
                    (this.blur = function () {
                        ...
                        return (
                            p.cssfilters
                                ? (b = "blur(" + m.intensity + "px)")
                                : p.svgfilters
                                    ? (i.setAttribute("stdDeviation", m.intensity), (b = "url(" + d + "#blur-effect-id-" + j + ")"))
                                    : (b = "progid:DXImageTransform.Microsoft.Blur(pixelradius=" + m.intensity + ")"),
                                (this.$elm[0].style[r] = b),
                                (q = !0),
                                this
                        );
                    }),
                    (this.animate = function (a, b) {
                        ...
                        return k && k.stop(!0, !0), (k = new c.Animation(m, { intensity: a }, c.extend(m.animationOptions, b)).progress(c.proxy(this.blur, this)).done(d.resolve)), d.promise();
                    }),
...
!(function (a) {
    ...
    a.pandalocker.storages.defaultStateStorage = function (b) {
        var c = b.options;
        (this.demo = c.demo),
            (this.useCookies = c.locker.useCookies),
            (this.expires = c.locker.expires),
            (this.isUnlocked = function (a) {
            ...
            (this.requestState = function (a, b) {
                return this.demo ? b("locked") : void b(this.isUnlocked(a) ? "unlocked" : "locked");
            }),
            ...
            (this._setValue = function (b) {
                ...
                if (this.expires) {
                    ...
                    (d = Math.ceil(this.expires / 86400)), (c = JSON.stringify({ expires: g }));
                }
                var h = !0;
                ...
                return h && a.pandalocker.tools.cookie(b, c, { expires: d, path: "/" }), !0;
            }),
            (this._getValue = function (b) {
                if (!b) return !1;
                var c = localStorage && !this.useCookies && localStorage.getItem(b);
                if ((c || (c = a.pandalocker.tools.cookie(b)), c))
                    try {
                        var d = JSON.parse(c);
                        if (d && d.expires) {
                            var e = new Date();
            ...
            (this._removeValue = function (b) {
                return b ? (localStorage && localStorage.removeItem(b), void a.pandalocker.tools.cookie(b, null)) : !1;
            });
    };
})(jQuery);
/*!
            ...
            (this.castToDate = function (a, b) {
                ...
                if ("range" === b) {
                    var g = new Date(a),
                        ...
                        i = g.getUTCMonth(),
                        j = g.getUTCFullYear();
                    return { range: !0, start: Date.UTC(j, i, h), end: Date.UTC(j, i, h, 23, 59, 59, 999) };
                }
                return a;
            });
    }),
        (a.pandalocker.services.visibilityProviders = {}),
        (a.pandalocker.services.visibilityProviders["user-mobile"] = {
            getValue: function () {
...
!(function (a) {
    ...
    a.pandalocker.services.subscription = function (b) {
        (this.id = b.id),
            (this.serviceOptions = b),
            (this.cookieName = "opanda_" + b.name + "_" + b.service + "_" + b.listId),
            (this.checkingInterval = b.checkingInterval || 1e4),
            (this._call = function (b, c, d) {
                var e = this,
                    f = {};
                (f.opandaIdentityData = c),
                    (f.opandaServiceData = d),
                    (f.opandaHandler = "subscription"),
                    (f.opandaRequestType = b),
                    (f.opandaService = this.serviceOptions.service),
                    (f.opandaListId = this.serviceOptions.listId),
                    (f.opandaDoubleOptin = this.serviceOptions.doubleOptin),
                    (f.opandaConfirm = this.serviceOptions.confirm),
                    (f.opandaRequireName = this.serviceOptions.requireName),
                    (f = a.pandalocker.filters.run(this.id + ".ajax-data", [f])),
                    (f = a.pandalocker.filters.run(this.id + ".subscribe.ajax-data", [f])),
                this.serviceOptions.parentId && (f = a.pandalocker.filters.apply("subscription-data-" + this.serviceOptions.parentId, f));
            ...
            (this.subscribe = function (b, c) {
                var d = this,
                    e = new a.Deferred();
                return (
                    this._call("subscribe", b, c)
                        .done(function (a) {
                            return (
                                console.log(a),
                                    a && a.error
                                        ? void e.reject(a)
                                        : a && "subscribed" === a.status
                                            ? void e.resolve(a)
                                            : d.serviceOptions.doubleOptin && d.serviceOptions.confirm
                                                ? (d._setWaitingStatus(b),
                                                    e.notify("waiting-confirmation"),
                                                    void d
                                                        .waitSubscription(b)
                                                        .done(function (a) {
                                                            e.resolve(a);
                        ...
                        .fail(function (b) {
                            (b && b.readyState < 4) || e.reject({ error: a.pandalocker.lang.errors.ajaxError });
                        }),
                        e.promise()
                );
            }),
            (this.waitSubscription = function (b) {
                var c = this,
                    d = new a.Deferred();
                return (
                    (this._waitingConfirmationResult = d),
                        c._isCanceled
                            ? void (c._isCanceled = !1)
                            : (this.check(b)
                                .done(function (a) {
                                    return c._isCanceled
                                        ? void (c._isCanceled = !1)
                                ...
                                .fail(function (a) {
                                    return c._isCanceled ? void (c._isCanceled = !1) : void d.reject(a);
                                }),
                                d.promise())
                );
            }),
            (this.check = function (b) {
                ...
                return (
                    this._call("check", b)
                        .done(function (a) {
                            return a.error ? void c.reject(a) : void c.resolve(a);
                        })
                        .fail(function (b) {
                            (b && b.readyState < 4) || c.reject({ error: a.pandalocker.lang.errors.ajaxError });
                        }),
                        c.promise()
                );
            }),
            (this.cancel = function () {
                ...
                this._waitingConfirmationResult && (this._waitingConfirmationResult.reject({ error: a.pandalocker.lang.errors_subscription_canceled }), (this._waitingConfirmationResult = null));
            }),
            (this._setWaitingStatus = function (b) {
                ...
                if (localStorage && localStorage.setItem)
                    try {
                        ...
                        a.pandalocker.tools.cookie(this.cookieName, c, { expires: 365, path: "/" });
                    }
                else a.pandalocker.tools.cookie(this.cookieName, c, { expires: 365, path: "/" });
            }),
            (this._removeWaitingStatus = function () {
                localStorage && localStorage.removeItem && localStorage.removeItem(this.cookieName), a.pandalocker.tools.cookie(this.cookieName, !1, { expires: 0, path: "/" });
            }),
...
!(function (a) {
    "use strict";
    a.pandalocker.extras || (a.pandalocker.extras = {}),
        (a.pandalocker.extras.interrelation = {
            init: function () {
...
!(function (a) {
    "use strict";
    a.pandalocker.extras || (a.pandalocker.extras = {}),
        (a.pandalocker.extras.googleAnalytics = {
            init: function () {
                        ...
                        if (window._gaq || window.ga)
                            if ((e || (e = window.location.href), "button" === c)) {
                                ...
                                (f =
                                    ...
                                    a("Lockers", "Unlocked (Total)", e),
                                    a("Lockers ", "Unlocked via " + f, e);
        ...
        (a.pandalocker.extras.na = {
            init: function () {
                var a = this,
                    ...
                    d = {},
                    e = function () {
                        for (var b = 0, c = 0; c < a._groups.length; c++) for (var d = 0; d < a._groups[c].controls.length; d++) b++;
                        return b;
                    };
    ...
    (b.init = function (b, c) {
        ...
        if (
            ((this.options = a.extend(!0, d, c)),
                (this.groupOptions = b.options),
                (this.lockerOptions = b.locker.options),
                (this.lang = b.lang),
                (this.group = b),
                (this.locker = b.locker),
            this.groupOptions.senderName && (this.senderName = this.groupOptions.senderName),
                !this.name)
        )
        ...
        (b._defaults = {}),
        (b.renderControl = function (b) {
            (this.control = a(this.tag || "<div>")
                .addClass("onp-sl-control")
                .addClass("onp-sl-" + this.name)
                .appendTo(b)),
                (this.innerWrap = a("<div></div>").addClass("onp-sl-control-inner-wrap").appendTo(this.control)),
                (this._isRendered = !0),
            this._hasError() && this.showError(),
        ...
        (b.showError = function (a, b) {
            var c = this;
            if ((this.runHook("control-error", [c.name, c.group.name]), !this._isRendered)) return void this._setError(a);
        ...
        (b.attemptToLoad = function (b, c, d, e) {
            ...
            return (
                h.done(function () {
                    ...
                    h.fail(function (a) {
                        console.log('Failed to load SDK script "' + b + '" due to the error "' + a + '". ' + d + " attempts left."),
                        "timeout" !== a && "blocked" !== a && g.reject(a),
                            0 >= d - 1
                                ? g.reject(a)
                                : f
                                    .attemptToLoad(b, c, d - 1, e)
                                    .done(function () {
                                        g.resolve();
                                    })
                                    .fail(function () {
        ...
        (b.verifyButton = function () {
            var b = this,
                ...
                e = function () {
                    if (0 === b.control.find(b.verification.container).length && d >= 0)
                        return (
                            setTimeout(function () {
                                e();
                            }, 500),
    ...
    (b.setup = function () {
        ...
        (b.runActions = function (b, c, d) {
            ...
            if (!this._actionsDone) {
                ...
                var h = function () {
                    var i = g.shift();
                    if (!i) return e.resolve(), void f.unlock();
                    ...
                    f[k](b, c, j, d, function (a) {
                        return "error" === a ? (f.runHook("raw-error"), e.reject(a), (f._actionsDone = !1), f.showScreen("default")) : void h();
                    });
                };
                return h(), e.promise();
            }
        ...
        (b.runSignupAction = function (b, c, d, e, f) {
            var g = this,
                h = function () {
                    ...
                    var c = {};
                    return (
                        (c.opandaIdentityData = b),
                            (c.opandaHandler = "signup"),
                            (c = a.pandalocker.filters.run(g.locker.id + ".ajax-data", [c])),
                            (c = a.pandalocker.filters.run(g.locker.id + ".signup.ajax-data", [c])),
                            a.ajax({
                                type: "POST",
                                dataType: "json",
                                ...
                                error: function (a) {
                                    (a && a.readyState < 4) ||
                                    (g.showScreen("default"), g.showError("Unable to sign in, the ajax error occurred."), f("error"), console && console.log && (console.log("Invalide ajax response:"), console.log(a.responseText)));
                                },
                            })
                    );
                };
        ...
        (b.runLeadAction = function (b, c, d, e, f) {
            var g = this,
                h = function () {
                    ...
                    return (
                        (c.opandaIdentityData = b),
                            (c.opandaHandler = "lead"),
                            (c = a.pandalocker.filters.run(g.locker.id + ".ajax-data", [c])),
                            (c = a.pandalocker.filters.run(g.locker.id + ".lead.ajax-data", [c])),
                            a.ajax({
                                type: "POST",
                                dataType: "json",
                                url: g.lockerOptions.proxy,
        ...
        (b._checkWaitingSubscription = function () {
            if (this.subscriptionService && this.subscriptionService.isWaitingSubscription()) {
                ...
                var c = this;
                this.showScreen("email-confirmation", { service: c.subscriptionService, email: a.email });
            }
        }),
            ...
            return (
                a.done(function () {
                    ...
                    a.progress(function (a) {
                        c.showScreen("email-confirmation", { service: c.subscriptionService, email: b.email });
                    }),
                    a
            );
        }),
...
!(function (a) {
    ...
    (b._defaults = {}),
        (b.init = function (b, c) {
            var d = this;
            (this.locker = b), (this.lockerOptions = b.options), (this.lang = b.lang), c || (c = {});
            ...
            if (
                ((this.isFirst = 1 === c.index),
                    (this.isLast = c.index === this.lockerOptions.groups.order.length),
                    (this.isSingle = 1 === this.lockerOptions.groups.order.length),
                "object" != typeof this.options.text && (this.options.text = { message: d.options.text }),
                this.isFirst &&
                ((this.options.text.header = "" === this.options.text.header ? "" : this.options.text.header || this.lang.defaultHeader),
                    (this.options.text.message = "" === this.options.text.message ? "" : this.options.text.message || this.lang.defaultMessage)),
                    (this.options.text.header = a.pandalocker.tools.normilizeHtmlOption(this.options.text.header)),
                    (this.options.text.message = a.pandalocker.tools.normilizeHtmlOption(this.options.text.message)),
                    (this.options.text.footer = a.pandalocker.tools.normilizeHtmlOption(this.options.text.footer)),
                !1 !== this.options.separator)
            ) {
                var g = a.isPlainObject(this.options.separator) ? this.options.separator : { type: "line", title: d.options.separator };
        ...
        (b.requestState = function (a) {
            for (var b = this.controls.length, c = "locked", d = 0; d < this.controls.length; d++)
                this.controls[d].requestState(function (d) {
        ...
        (b.renderGroup = function (b) {
            ...
            if (
                (d.appendTo(c),
                    c.addClass(this.isFirst ? "onp-sl-first-group" : this.isLast ? "onp-sl-last-group" : "onp-sl-middle-group"),
                    c.addClass(this.isSingle ? "onp-sl-single-group" : "onp-sl-not-single-group"),
                    c.addClass("onp-sl-group-index-" + this.options.index),
                    (this.element = c),
                    (this.innerWrap = d),
                    this.renderSeparator(),
                this.options.text.header || this.options.text.message)
            ) {
        ...
        (b.showNotice = function (b, c, d) {
            ...
            var e = a("<div class='onp-sl-group-notice'>" + b + "</div>").hide();
            this.innerWrap.append(e),
                e.fadeIn(500),
            c || (c = 7e3),
                setTimeout(function () {
                    e.length &&
...
!(function (a) {
    ...
    (b._defaults = {
        ...
        counters: !0,
        facebook: { version: "v2.5", like: { title: a.pandalocker.lang.socialButtons.facebookLike }, share: { title: a.pandalocker.lang.socialButtons.facebookShare } },
        twitter: { tweet: { title: a.pandalocker.lang.socialButtons.twitterTweet }, follow: { title: a.pandalocker.lang.socialButtons.twitterFollow } },
        google: { plus: { title: a.pandalocker.lang.socialButtons.googlePlus }, share: { title: a.pandalocker.lang.socialButtons.googleShare } },
        youtube: { title: a.pandalocker.lang.socialButtons.youtubeSubscribe },
        linkedin: { share: { title: a.pandalocker.lang.socialButtons.linkedinShare } },
    }),
        (b.name = "social-buttons"),
        (b.prepareOptions = function () {
            (this.options.lang = this.locker.options.lang),
            "horizontal" !== this.options.layout && "vertical" !== this.options.layout && (this.options.layout = "horizontal"),
                (this.options.url = this.options.url || this.locker.options.url),
            this.locker.options.buttons &&
            (this.locker.options.buttons.order && (this.options.order = this.locker.options.buttons.order),
            "undefined" != typeof this.locker.options.buttons.counters && (this.options.counters = this.locker.options.buttons.counters)),
            this.locker.options.facebook && (this.options.facebook = a.extend(!0, this.options.facebook, this.locker.options.facebook)),
            this.locker.options.twitter && (this.options.twitter = a.extend(!0, this.options.twitter, this.locker.options.twitter)),
            this.locker.options.google && (this.options.google = a.extend(!0, this.options.google, this.locker.options.google)),
            this.locker.options.linkedin && (this.options.linkedin = a.extend(!0, this.options.linkedin, this.locker.options.linkedin)),
            this.locker.options.youtube && (this.options.youtube = a.extend(!0, this.options.youtube, this.locker.options.youtube));
        }),
        (b.render = function () {
...
!(function (a) {
    ...
    (b.init = function (b, c, d) {
        ...
        (this.networkName = this.sdk ? this.sdk : 2 === e.length ? e[0] : null),
            (this.buttonName = 2 === e.length ? e[1] : e[0]),
            a.pandalocker.entity.control.init.call(this, b, c),
            (this._ssIdentity = this.networkName ? "page_" + a.pandalocker.tools.hash(this.url) + "_hash_" + this.networkName + "-" + this.buttonName : "page_" + a.pandalocker.tools.hash(this.url) + "_hash_" + this.buttonName);
    }),
        ...
        (b.render = function (b) {
            var c = this;
            if (
                (this.networkName && this.control.addClass("onp-sl-" + this.networkName),
                    (this.container = a("<div class='onp-sl-social-button onp-sl-social-button-" + this.name + "'></div>")),
                    this.container.appendTo(b),
                    !this._hasError())
            ) {
        ...
        (b._addFlipEffect = function () {
            ...
            var f = this.options.title || (this.networkName ? a.pandalocker.lang[this.networkName + "_" + this.buttonName] : a.pandalocker.lang[this.networkName]),
                g = a("<a href='#'></a>")
                    ...
                    .append(a("<div class='onp-sl-overlay-back'></div>"))
                    .append(
                        a("<div class='onp-sl-overlay-front'></div>")
                            .append(a("<div class='onp-sl-overlay-icon'></div>"))
                            .append(a("<div class='onp-sl-overlay-line'></div>"))
                            .append(a("<div class='onp-sl-overlay-text'>" + f + "</div>"))
                    )
                    .append(a("<div class='onp-sl-overlay-header'></div>"));
            g.prependTo(c),
            e ||
            b.hover(
                function () {
            ...
            this.group._buttonsZIndex || (this.group._buttonsZIndex = 54),
        ...
        (b.verification = { container: "iframe", timeout: 5e3 }),
...
!(function (a) {
    ...
    a.pandalocker.sdk || (a.pandalocker.sdk = {}),
        (a.pandalocker.sdk.facebook = a.pandalocker.sdk.facebook || {
            name: "facebook",
            ...
            setup: function () {
                if (!this._setup) {
                    var b = this;
                    window.FB.init({ appId: (b.options && b.options.appId) || null, status: !0, cookie: !0, xfbml: !0, version: b.options.version }),
...
!(function (a) {
    ...
    a.onepress || (a.onepress = {}),
    a.pandalocker.sdk || (a.pandalocker.sdk = {}),
        (a.pandalocker.sdk.twitter = a.pandalocker.sdk.twitter || {
            name: "twitter",
            ...
            createEvents: function () {
                ...
                return c
                    ...
                    window.twttr.ready ||
                    (window.twttr = a.extend(window.twttr, {
                        _e: [],
                        ready: function (a) {
                            this._e.push(a);
                        },
                    })),
                        void twttr.ready(function () {
                            d();
                        }));
            },
            prepare: function () {
                var b = function (b) {
                    return (b || b.data) && "string" == typeof b.data
                        ? -1 !== b.data.indexOf(':["tweet"')
                            ? a(document).trigger("onp-sl-twitter-tweet")
                            : -1 !== b.data.indexOf(':["follow"')
                                ? a(document).trigger("onp-sl-twitter-follow")
                                : void 0
                        : void 0;
                };
...
!(function (a) {
    ...
    a.onepress || (a.onepress = {}),
    a.pandalocker.sdk || (a.pandalocker.sdk = {}),
        (a.pandalocker.sdk.google = a.pandalocker.sdk.google || {
            name: "google",
            ...
            prepare: function () {
                ...
                if (
                    ((window.___gcfg = window.___gcfg || { lang: c }),
                    ...
                    var d = function (c) {
                        if ((c || c.data) && "string" == typeof c.data && -1 === c.data.indexOf("oauth2relay")) {
                            if (-1 !== c.data.indexOf("::drefresh")) return void (b.notAuthed = !0);
                            if (-1 !== c.data.indexOf("::_g_wasClosed") || -1 !== c.data.indexOf("::_g_closeMe")) {
                                if (b.notAuthed) return void (b.notAuthed = !1);
...
!(function (a) {
    ...
    a.onepress || (a.onepress = {}),
    a.pandalocker.sdk || (a.pandalocker.sdk = {}),
        (a.pandalocker.sdk.googleClient = a.pandalocker.sdk.googleClient || {
            name: "google-client",
...
!(function (a) {
    ...
    a.onepress || (a.onepress = {}),
    a.pandalocker.sdk || (a.pandalocker.sdk = {}),
        (a.pandalocker.sdk.linkedin = a.pandalocker.sdk.linkedin || {
            name: "linkedin",
            ...
            prepare: function () {
                ...
                window.open = function (c, d, e) {
                    ...
                    if (!f) return f;
                    var g = d || f.name;
                    return g ? ("easyXDM_IN" !== g.substring(0, 10) ? f : void (a.pandalocker.sdk.linkedin._activePopup = f)) : f;
                };
            },
        });
})(jQuery);
...
!(function (a) {
    ...
    (b.name = "facebook-like"),
        (b._defaults = { url: null, layout: "button_count", width: null, verbToDisplay: "like", colorScheme: "light", font: "tahoma", ref: null, theConfirmIssue: !1 }),
        (b.prepareOptions = function () {
        ...
        (b.renderButton = function (b) {
            (this.button = a("<div></div>").appendTo(b)),
                ...
                (this._trackIFrameTimer = null),
                    this.locker.locker.hover(
                        function () {
                            ...
                            c.length &&
                            (b._trackIFrameTimer = setInterval(function () {
...
!(function (a) {
    "use strict";
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);
    (b.name = "facebook-share"),
        (b._defaults = { url: null, layout: "button_count", count: "standard", lang: "en_US", width: null, shareDialog: !1, name: null, caption: null, description: null, image: null, unlock: null }),
        (b.prepareOptions = function () {
            return (
                (this.url = this._extractUrl()),
                    this.options.appId && "117100935120196" != this.options.appId
                        ? void ("vertical" === this.groupOptions.layout ? (this.options.layout = "box_count") : this.groupOptions.counters || (this.options.layout = "button"))
                        : (this.showError(a.pandalocker.lang.errors.emptyFBAppIdError), !1)
            );
        }),
        (b.setupEvents = function () {
            var b = this;
        ...
        (b.renderButton = function (b) {
            ...
            d.click(
                c.options.shareDialog
                    ? function () {
                        return (
                            FB.ui({ method: "share", href: c.url, display: "popup" }, function (b) {
                                return (
                                    console && console.log && console.log("AX12:"),
                                    console && console.log && console.log(b),
                                        (a.pandalocker.tools.isTabletOrMobile() && "undefined" == typeof b) || null === b
                                            ? void a(document).trigger("onp-sl-facebook-share", [c.url])
                                            : void ("undefined" != typeof b && null !== b && (("object" == typeof b && b.error_code && b.error_code > 0) || a(document).trigger("onp-sl-facebook-share", [c.url])))
                                );
                            }),
                                !1
                        );
                    ...
                    : function () {
                        // unlock content when facebook share popup closed
                        var fb_share_url = 'https://www.facebook.com/sharer/sharer.php?u=' + c.url;
                        var pop_win = window.open(fb_share_url, '_blank', "height=200,width=200");
                        let t = 0;
                        var timer = setInterval(function() {
                            if(pop_win.closed) {
                                clearInterval(timer);
                                if (t==0) {
                                    setTimeout(function() { a(document).trigger("onp-sl-facebook-share", [c.url]); }, 3000);
                                } else {
                                    a(document).trigger("onp-sl-facebook-share", [c.url]);
                                }
                            }
                            t++;
                        }, 1000);
                        ...
                        return (
                            FB.ui({ method: "feed", name: c.options.name, link: c.url, picture: c.options.image, caption: c.options.caption, description: c.options.description }, function (b) {
                                return (
                                    console && console.log && console.log("AX12:"),
                                    console && console.log && console.log(b),
                                        (a.pandalocker.tools.isTabletOrMobile() && "undefined" == typeof b) || null === b
...
!(function (a) {
    ...
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);
    (b.name = "twitter-tweet"),
        (b.verification = { container: "iframe", timeout: 6e5 }),
        (b._defaults = { doubleCheck: !1, url: null, text: null, via: null, related: null, count: "horizontal", lang: "en", counturl: null, size: "medium" }),
        (b.prepareOptions = function () {
            if (
                (!this.options.url && !this.networkOptions.url && a("link[rel='canonical']").length > 0 && (this.options.url = a("link[rel='canonical']").attr("href")),
                    (this.url = this._extractUrl()),
                    "vertical" === this.groupOptions.layout ? this.showError(a.pandalocker.lang.errors.unsupportedTwitterTweetLayout) : this.groupOptions.counters || (this.options.count = "none"),
                    this.groupOptions.lang)
            ) {
        ...
        (b.setupEvents = function () {
            ...
            a(document).bind("onp-sl-twitter-tweet", function () {
                b.url === a.pandalocker.data.__tweetedUrl &&
                (a.pandalocker.data.__tweetWindow && a.pandalocker.data.__tweetWindow.close && a.pandalocker.data.__tweetWindow.close(), (a.pandalocker.data.__tweetWindow = null), b.unlock("button", b.name, b.url));
            });
        }),
        (b.renderButton = function (b) {
            var c = this;
            (this.button = a('<a href="https://twitter.com/share" class="twitter-share-button">Tweet</a>').appendTo(b)),
            ...
            d.click(function () {
                ...
                b.done(function () {
                   // delay 5s before unlock content
                    setTimeout(function() {
        ...
        (b.tweet = function (b) {
            ...
            c.options.hashtags && e.push(["hashtags", c.options.hashtags]),
            c.options.via && e.push(["via", c.options.via]),
            c.options.related && e.push(["via", c.options.related]),
                e.push(["url", c.url]),
                (a.pandalocker.data.__tweetedUrl = c.url);
            ...
            return (
                a.pandalocker.data.__twitterAuth && a.pandalocker.data.__twitterAuth.closed === !1
                    ? (a.pandalocker.data.__twitterAuth.updateState(g, h, i, j, k), (a.pandalocker.data.__tweetWindow = a.pandalocker.data.__twitterAuth), (a.pandalocker.data.__twitterAuth = null))
                    : (a.pandalocker.data.__tweetWindow = window.open(g, "TwitterTweetWindow", "width=" + h + ",height=" + i + ",left=" + j + ",top=" + k)),
                    setTimeout(function () {
        ...
        (b.connect = function (b) {
            var c = this;
            if (a.pandalocker.data.twitterOAuthReady)
                a.pandalocker.data.__twitterAuthIdentityData
                    ? b(a.pandalocker.data.__twitterAuthIdentityData, c._getServiceData())
                    : this._identify(function (a) {
                ...
                var h = 500,
                    ...
                    j = screen.width ? screen.width / 2 - h / 2 + a.pandalocker.tools.findLeftWindowBoundry() : 0,
                    k = screen.height ? screen.height / 2 - i / 2 + a.pandalocker.tools.findTopWindowBoundry() : 0;
                (a.pandalocker.data.__twitterAuth = window.open(f, "Twitter Tweet", "width=" + h + ",height=" + i + ",left=" + j + ",top=" + k + ",resizable=yes,scrollbars=yes,status=yes")),
        ...
        (b._saveVisitorId = function (b) {
            (this._visitorId = b), (a.pandalocker.data.__twitterVisitorId = b), a.pandalocker.tools.cookie("opanda_twid", b, { expires: 1e3, path: "/" });
        }),
        ...
        (b._identify = function (b) {
            var c = this,
                d = a.ajax({
                    ...
                    dataType: "json",
                    url: c.options.proxy,
                    data: { opandaHandler: "twitter", opandaRequestType: "user_info", opandaVisitorId: a.pandalocker.data.__twitterVisitorId, opandaReadOnly: !0 },
                    success: function (c) {
                        console.log(c), (!c || c.error || c.errors) && console && console.log && console.log("Unable to get the user data: " + d.responseText);
                        var e = {};
                        (e.displayName = c.screen_name),
                            (e.twitterUrl = "https://twitter.com/" + c.screen_name),
                        c.profile_image_url && (e.image = c.profile_image_url.replace("_normal", "")),
                            (a.pandalocker.data.__twitterAuthIdentityData = e),
                            b(e);
                    },
                    error: function () {
        ...
        (b.checkTweet = function () {
            var b = this,
                ...
                d = a.ajax({
                    ...
                    dataType: "json",
                    url: b.options.proxy,
                    data: { opandaHandler: "twitter", opandaRequestType: "get_tweets", opandaVisitorId: a.pandalocker.data.__twitterVisitorId, opandaReadOnly: !0 },
                    success: function (a) {
...
!(function (a) {
    ...
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);
    (b.name = "twitter-follow"),
        (b.verification = { container: "iframe", timeout: 6e5 }),
        (b._defaults = { doubleCheck: !1, url: null, hideScreenName: !1, showCount: !0, lang: "en", size: "medium" }),
        (b.prepareOptions = function () {
            ...
            if (
                ((this.url = this._extractUrl()),
                    "vertical" === this.groupOptions.layout ? this.showError(a.pandalocker.lang.errors.unsupportedTwitterFollowLayout) : this.groupOptions.counters || (this.options.showCount = !1),
                    this.groupOptions.lang)
            ) {
                var b = this.groupOptions.lang.split("_");
                this.options.lang = b[0];
        ...
        (b.setupEvents = function () {
            ...
            a(document).bind("onp-sl-twitter-follow", function () {
                b.url === a.pandalocker.data.__followedUrl &&
                (a.pandalocker.data.__followWindow && a.pandalocker.data.__followWindow.close && a.pandalocker.data.__followWindow.close(), (a.pandalocker.data.__followWindow = null), b.unlock("button", b.name, b.url));
            });
        }),
        (b.renderButton = function (b) {
            var c = this;
            (this.button = a('<a href="https://twitter.com/share" class="twitter-follow-button">Follow</a>').appendTo(b)),
            ...
            this.options.size && this.button.attr("data-size", this.options.size),
            this.options.dnt && this.button.attr("data-dnt", this.options.dnt),
            this.options.hideScreenName && this.button.attr("data-show-screen-name", !1);
            var d = a("<div class='onp-sl-feature-overlay'></div>").appendTo(b);
            d.click(function () {
        ...
        (b.follow = function (b) {
            ...
            return (
                a.pandalocker.data.__twitterAuth && a.pandalocker.data.__twitterAuth.closed === !1
                    ? (a.pandalocker.data.__twitterAuth.updateState(g, h, i, j, k), (a.pandalocker.data.__followWindow = a.pandalocker.data.__twitterAuth), (a.pandalocker.data.__twitterAuth = null))
                    : (a.pandalocker.data.__followWindow = window.open(g, "TwitterFollowWindow", "width=" + h + ",height=" + i + ",left=" + j + ",top=" + k)),
                    setTimeout(function () {
                        var b = setInterval(function () {
        ...
        (b.connect = function (b) {
            ...
            if (a.pandalocker.data.twitterOAuthReady)
                ...
                var h = 500,
                    ...
                    j = screen.width ? screen.width / 2 - h / 2 + a.pandalocker.tools.findLeftWindowBoundry() : 0,
                    k = screen.height ? screen.height / 2 - i / 2 + a.pandalocker.tools.findTopWindowBoundry() : 0;
                (a.pandalocker.data.__twitterAuth = window.open(f, "Twitter Follow", "width=" + h + ",height=" + i + ",left=" + j + ",top=" + k + ",resizable=yes,scrollbars=yes,status=yes")),
                    (window.OPanda_TwitterOAuthCompleted = function (d) {
                        (a.pandalocker.data.twitterOAuthReady = !0), c._saveVisitorId(d), c.connect(b);
                    }),
                    (window.OPanda_TwitterOAuthDenied = function (b) {
        ...
        (b.checkFollower = function () {
            var b = this,
                ...
                d = a.ajax({
                    ...
                    dataType: "json",
                    url: b.options.proxy,
                    data: { opandaHandler: "twitter", opandaRequestType: "get_followers", opandaSceenName: b.screenName, opandaVisitorId: a.pandalocker.data.__twitterVisitorId, opandaReadOnly: !0 },
                    success: function (a) {
                        if (((!a || a.error || a.errors) && console && console.log && console.log("Unable to get the user data: " + d.responseText), a[0]))
                            for (var b = 0; b < a[0].connections.length; b++) if ("following" === a[0].connections[b]) return void c.resolve();
                        c.reject();
                    },
                    error: function () {
                        console && console.log && console.log("Unable to get the user data: " + d.responseText), callback({});
...
!(function (a) {
    ...
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);
    (b.name = "google-plus"),
        (b._defaults = { url: null, lang: "en-US", size: "medium", annotation: null, width: null, align: "left", expandTo: "", recommendations: !0 }),
        (b.prepareOptions = function () {
            (this.url = this._extractUrl()), "vertical" === this.groupOptions.layout ? (this.options.size = "tall") : this.groupOptions.counters || (this.options.annotation = "none");
        }),
        (b.setupEvents = function () {
            var b = this;
...
!(function (a) {
    ...
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);
    (b.name = "google-share"),
        (b._defaults = { url: null, lang: "en-US", size: null, annotation: "bubble", width: null, align: "left", expandTo: "", recommendations: !0 }),
        (b.prepareOptions = function () {
            (this.url = this._extractUrl()), "vertical" === this.groupOptions.layout ? (this.options.annotation = "vertical-bubble") : this.groupOptions.counters || (this.options.annotation = "none");
        }),
        (b.setupEvents = function () {
            var b = this;
        ...
        (b.renderButton = function (b) {
            ...
            if (
                ...
                d.click(function () {
                    var b = [];
                    b.push(["url", c.url]);
                    var d = a.pandalocker.tools.URL().scheme("https").host("plus.google.com").path("/share").query(b),
                        e = 550,
                        f = 420,
                        g = screen.width ? screen.width / 2 - 350 + a.pandalocker.tools.findLeftWindowBoundry() : 0,
                        h = screen.height ? screen.height / 2 - 225 + a.pandalocker.tools.findTopWindowBoundry() : 0,
                        i = window.open(d, "GoogleShareWindow", "width=" + e + ",height=" + f + ",left=" + g + ",top=" + h);
                    return (
                        setTimeout(function () {
                            var b = setInterval(function () {
                                (i && i.closed === !1) || (clearInterval(b), a(document).trigger("onp-sl-google-share", [c.url]));
                            }, 200);
                        }, 200),
                            !1
                    );
...
!(function (a) {
    "use strict";
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);
    (b.name = "youtube-subscribe"),
        (b.sdk = "google-client"),
        (b._defaults = { clientId: null, channelId: null, layout: "default", count: "default" }),
        (b._extractUrl = function () {
            return this.options.channelId;
        }),
        (b.prepareOptions = function () {
            (this.url = this._extractUrl()),
            this.options.channelId || this.showError(a.pandalocker.lang.errors.emptyYoutubeChannelId),
            this.options.clientId || this.showError(a.pandalocker.lang.errors.emptyGoogleClientId),
                "vertical" === this.groupOptions.layout ? this.showError(a.pandalocker.lang.errors.unsupportedYoutubeSubscribeLayout) : this.groupOptions.counters || (this.options.count = "hidden");
        }),
        (b.setupEvents = function () {
            var b = this;
        ...
        (b.renderButton = function (b) {
            ...
            d.click(function () {
                return (
                    c.authorize(!1, function (b) {
                        return "immediate_failed" !== b.error ? (b && b.status.signed_in ? void c.subscribe() : void c.showNotice(a.pandalocker.lang.errors_not_signed_in)) : void 0;
                    }),
                        !1
                );
            });
        ...
        (b.subscribe = function () {
            ...
            gapi.client.load("youtube", "v3", function () {
                var c = gapi.client.youtube.subscriptions.insert({ part: "snippet", resource: { snippet: { resourceId: { kind: "youtube#channel", channelId: b.options.channelId } } } });
                c.execute(function (c) {
                    return c.error && "subscriptionDuplicate" != c.error.data[0].reason ? b.showNotice(c.error.data[0].message) : void a(document).trigger("onp-sl-youtube-subscribe");
                });
            });
        }),
...
!(function (a) {
    "use strict";
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.socialButton);
    (b.name = "linkedin-share"),
        (b.verification.container = ".IN-widget"),
        (b.verification.timeout = 5e3),
        (b._defaults = { url: null, counter: "right" }),
        (b.prepareOptions = function () {
        ...
        (b.renderButton = function (b) {
            var c = this;
            (this.button = a('<script type="IN/Share" data-onsuccess="OPanda_LinkedinShare_Callback" data-success="OPanda_LinkedinShare_Callback" data-onSuccess="OPanda_LinkedinShare_Callback"></script>')),
            this.options.counter && this.button.attr("data-counter", this.options.counter),
                this.button.attr("data-url", this.url),
                this.button.appendTo(b),
                IN.init(),
            IN.parse && IN.parse(this.button[0]),
                b.click(function () {
                    setTimeout(function () {
...
!(function (a) {
    "use strict";
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.group);
    (b._defaults = { order: ["facebook", "twitter", "google"], facebook: { version: "v2.5" }, twitter: {}, google: {}, linkedin: {} }),
        (b.name = "connect-buttons"),
        (b.setup = function () {
    ...
    (b.tag = '<a href="#"></a>'),
        (b.render = function (b) {
            ...
            if (
                ((this.sdk = this.sdk || this.name),
                    ...
                    (this.icon = a("<div class='onp-sl-icon'></div>")),
                    this.icon.appendTo(b),
                    (this.container = a("<div class='onp-sl-connect-button onp-sl-social-button-" + this.name + "'></div>")),
                    this.container.appendTo(b),
                    !this._hasError())
            ) {
        ...
        (b.handleClick = function () {
            ...
            this.control.click(function () {
                return (
                    a.runHook("raw-interaction"),
                        a._hasError() || a._isLoading()
                            ? void 0
                            : (a.connect(function (b, c) {
                                a.runActions(b, c, !0);
                            }),
                                !1)
                );
...
!(function (a) {
    ...
    (b.name = "facebook"),
        ...
        (b.connect = function (b) {
            var c = this;
            if ("connected" === c._status && !this.restPermissions.length)
                return this._identify(function (a) {
                    b(a, c._serviceData);
                });
            var d = { scope: c.restPermissions.join(",") };
            ...
            c._trackWindow("facebook.com/dialog/oauth", function () {
                ...
                FB.login(function (d) {
                    (e = !0),
                        c._checkPermissions(d, function () {
                            return "connected" !== c._status
                                ? (c.runHook("raw-social-app-declined"), void c.showNotice(a.pandalocker.lang.errors_not_signed_in))
                                : c.restPermissions.length
                                    ? (c.runHook("raw-social-app-declined"), void c.showNotice(a.pandalocker.lang.res_errors_not_granted.replace("{permissions}", c.restPermissions.join(", "))))
                                    : c._identify(function (a) {
                                        b(a, c._serviceData);
                                    });
                        });
                }, d);
        ...
        (b._checkPermissions = function (b, c) {
            var d = this;
            return (
                (this._status = b.status),
                    (this._serviceData = b),
                    b && "connected" === this._status
                        ? void FB.api("/me/permissions", function (b) {
                            if (b && b.data) {
        ...
        (b._identify = function (a) {
            FB.api("/me?fields=email,first_name,last_name,gender,link", function (b) {
                ...
                return b
                    ? ((c.source = "facebook"),
                        (c.email = b.email),
                        (c.displayName = b.first_name + " " + b.last_name),
                        (c.name = b.first_name),
                        (c.family = b.last_name),
                        (c.gender = b.gender),
                        (c.facebookUrl = b.link),
                        (c.image = "https://graph.facebook.com/" + b.id + "/picture?type=large"),
                        (c.social = !0),
                        void a(c))
                    : a(c);
            });
    ...
    (b.name = "google"),
        ...
        (b.prepareOptions = function () {
            return this.options.clientId
                ? ((this.permissions = ["https://www.googleapis.com/auth/userinfo.profile"]),
                    ...
                    -1 === a.inArray("youtube-subscribe", this.options.actions) || (this.permissions.push("https://www.googleapis.com/auth/youtube"), this.options.youtubeSubscribe && this.options.youtubeSubscribe.channelId)
                        ? ((this.restPermissions = this.permissions), void (this.declinedPermissions = []))
                        : this.showError(a.pandalocker.lang.connectButtons.errorYouTubeChannelMissed))
                : void this.showError(a.pandalocker.lang.connectButtons.google.clientIdMissed);
        }),
        (b.renderButton = function (b) {
        ...
        (b.connect = function (b) {
            var c = this,
                ...
                e = {
                    callback: function (e) {
                        return "immediate_failed" !== e.error
                            ? ((d = !0),
                                e && e.status.signed_in
                                    ? c._identify(function (d, f) {
                                        return "error" === d ? void c.showNotice(a.pandalocker.lang.connectButtons.google.unexpectedError.replace("{0}", f)) : void b(f, e);
                                    })
                                    : (c.runHook("raw-social-app-declined"), void c.showNotice(a.pandalocker.lang.errors_not_signed_in)))
                            : void 0;
                    },
            ...
            gapi.client.load("plus", "v1").then(function () {
                gapi.client.plus.people.get({ userId: "me" }).then(
                    function (b) {
                        ...
                        return b && b.result
                            ? ((c.source = "google"),
                                (c.email = b.result.emails && b.result.emails[0] && b.result.emails[0].value),
                                (c.displayName = b.result.displayName),
                                (c.name = b.result.name && b.result.name.givenName),
                                (c.family = b.result.name && b.result.name.familyName),
                                (c.gender = b.result.gender),
                                (c.googleUrl = b.result.url),
                                (c.social = !0),
                            b.result.image && b.result.image.url && (c.image = b.result.image.url.replace(/\?sz=\d+/gi, "")),
                                void a("success", c))
                            : a("error", c);
                    },
                    function (b) {
        ...
        (b.runYoutubeSubscribeAction = function (a, b, c, d, e) {
            var f = this;
            gapi.client.load("youtube", "v3", function () {
                var a = gapi.client.youtube.subscriptions.insert({ part: "snippet", resource: { snippet: { resourceId: { kind: "youtube#channel", channelId: f.options.youtubeSubscribe.channelId } } } });
                a.execute(function (a) {
                    return a && a.error
                        ? a.error.data && a.error.data[0] && "subscriptionDuplicate" === a.error.data[0].reason
                            ? void e()
                            : (console && console.log && console.log(a), f.showError(a.error.message), void e("error"))
                        : (f.runHook("got-youtube-subscriber", [a]), void e());
                });
            });
        }),
    ...
    (b.name = "twitter"),
        ...
        (b.prepareOptions = function () {
            return this.options.proxy
                ? -1 === a.inArray("follow", this.options.actions) || (this.options.follow && this.options.follow.user)
                    ? -1 === a.inArray("tweet", this.options.actions) || (this.options.tweet && this.options.tweet.message)
                        ? void 0
                        : this.showError(a.pandalocker.lang.connectButtons.errorTwitterMessageMissed)
                    : this.showError(a.pandalocker.lang.connectButtons.errorTwitterUserMissed)
                : void this.showError(a.pandalocker.lang.connectButtons.twitter.proxyEmpty);
        }),
        (b.renderButton = function (b) {
            var c = this,
        ...
        (b.connect = function (b) {
            ...
            if (a.pandalocker.data.twitterOAuthReady)
                ...
                delete d.proxy;
                var e = { opandaHandler: "twitter", opandaRequestType: "init", opandaTwitterOptions: JSON.stringify(d) },
        ...
        (b._saveVisitorId = function (b) {
            (this._visitorId = b), a.pandalocker.tools.cookie("opanda_twid", b, { expires: 1e3, path: "/" });
        }),
        (b._getServiceData = function () {
            var a = this;
            return { visitorId: a._visitorId };
        }),
        (b._identify = function (b) {
            var c = this,
                d = a.ajax({
                    ...
                    dataType: "json",
                    url: c.options.proxy,
                    data: { opandaHandler: "twitter", opandaRequestType: "user_info", opandaVisitorId: c._visitorId },
                    success: function (a) {
                        (!a || a.error || a.errors) && console && console.log && console.log("Unable to get the user data: " + d.responseText);
                        var c = {};
                        if (!a) return b(c);
                        ...
                        (c.source = "twitter"),
                            (c.email = a.email),
                            (c.displayName = a.screen_name),
                            (c.twitterUrl = "https://twitter.com/" + a.screen_name),
                        a.profile_image_url && (c.image = a.profile_image_url.replace("_normal", "")),
                            b(c);
                    },
                    error: function () {
                        console && console.log && console.log("Unable to get the user data: " + d.responseText), b({});
        ...
        (b.runFollowAction = function (b, c, d, e, f) {
            var g = this,
                h = { opandaHandler: "twitter", opandaRequestType: "follow", opandaVisitorId: g._visitorId, opandaFollowTo: d.user, opandaNotifications: d.notifications };
            (h = a.pandalocker.filters.run(g.locker.id + ".ajax-data", [h])), (h = a.pandalocker.filters.run(g.locker.id + ".twitter-follow.ajax-data", [h]));
            var i = a.ajax({ type: "POST", dataType: "json", url: g.options.proxy, data: h });
            i.success(function (a) {
                return (
                    (!a || a.error || a.errors) && console && console.log && console.log("Unable to follow: " + i.responseText),
                        a && a.error ? (g.showScreen("default"), void g.showNotice("Unable to perform the follow action due to the error: " + a.error)) : void f()
                );
            }),
                i.error(function () {
        ...
        (b.runTweetAction = function (b, c, d, e, f) {
            var g = this,
                h = { opandaHandler: "twitter", opandaRequestType: "tweet", opandaVisitorId: g._visitorId, opandaTweetMessage: d.message };
            (h = a.pandalocker.filters.run(g.locker.id + ".ajax-data", [h])), (h = a.pandalocker.filters.run(g.locker.id + ".twitter-tweet.ajax-data", [h]));
            var i = a.ajax({ type: "POST", dataType: "json", url: g.options.proxy, data: h });
            i.success(function (a) {
                return (
                    (!a || a.error || a.errors) && console && console.log && console.log("Unable to tweet: " + i.responseText),
                        a && a.error ? (g.showScreen("default"), void g.showNotice("Unable to perform the tweet action due to the error: " + a.error)) : void f()
                );
            }),
                i.error(function () {
...
!(function (a) {
    ...
    (b.name = "linkedin"),
        (b._defaults = {}),
        (b.prepareOptions = function () {
            return this.options.clientId ? void 0 : void this.showError(a.pandalocker.lang.connectButtons.linkedin.clientIdMissed);
        }),
        (b.renderButton = function (b) {
            var c = this,
        ...
        (b.connect = function (b) {
            var c = this;
            if (a.pandalocker.data.linkedInOAuthReady)
                this._identify(function (a) {
                    b(a, c._getServiceData());
                });
            else {
                var d = a.extend(!0, {}, c.options);
                delete d.proxy;
                var e = { opandaHandler: "linkedin", opandaRequestType: "init", opandaLinkedinOptions: JSON.stringify(d) },
                    f = c.options.proxy;
        ...
        (b._getServiceData = function () {
            var a = this;
            return { accessToken: a._accessToken };
        }),
        (b._identify = function (b) {
            var c = this,
                d = a.ajax({
                    ...
                    dataType: "json",
                    url: c.options.proxy,
                    data: { opandaHandler: "linkedin", opandaRequestType: "user_info", opandaAccessToken: c._accessToken },
                    success: function (a) {
                        (!a || a.error || a.errors) && console && console.log && console.log("Unable to get the user data: " + d.responseText);
                        var c = {};
                        return a
                            ? ((c.source = "linkedin"),
                                (c.email = a.emailAddress),
                                (c.displayName = a.firstName + " " + a.lastName),
                                (c.name = a.firstName),
                                (c.family = a.lastName),
                                (c.linkedinUrl = a.publicProfileUrl),
                                (c.social = !0),
                            a.pictureUrls && a.pictureUrls.values && (c.image = a.pictureUrls.values[0]),
                                void b(c))
                            : b(c);
                    },
                    error: function () {
...
!(function (a) {
    ...
    a.onepress || (a.onepress = {}),
    a.pandalocker.sdk || (a.pandalocker.sdk = {}),
        (a.pandalocker.sdk.linkedinConnect = a.pandalocker.sdk.linkedinConnect || {
            ...
            createEvents: function () {
                var b = this,
                    c = this.isLoaded(),
                    d = function () {
                        window.IN.init({ api_key: b.options.apiKey }), (window.IN.init = function () {}), a(document).trigger(b.name + "-init");
                    };
                return c
                    ? void d()
                    : void a(document).bind(b.name + "-script-loaded", function () {
                        d();
                    });
            },
        });
...
!(function (a) {
    "use strict";
    var b = a.pandalocker.tools.extend(a.pandalocker.entity.group);
    (b._defaults = { order: ["form"], text: a.pandalocker.lang.subscription.defaultText, separator: { type: "hiding-link", title: a.pandalocker.lang.misc_or_enter_email } }),
        (b.name = "subscription"),
        (a.pandalocker.groups.subscription = b);
})(jQuery);
!(function ($) {
    "use strict";
    var form = $.pandalocker.tools.extend($.pandalocker.entity.actionControl);
    (form.name = "form"),
        (form._defaults = { type: "email-form", fields: null, unlocksPerPage: !1 }),
        (form.setup = function () {
            (this.options.actions && 0 !== this.options.actions.length) || (this.options.actions = ["subscribe"]),
                $.pandalocker.entity.actionControl.setup.apply(this),
                (this.options.requireName = this.options.requireName || (this.options.subscribe && this.options.subscribe.requireName)),
                (this.advancedValidation = !0),
                "email-form" === this.options.type
                    ? ((this.advancedValidation = !1), (this.options.fields = [{ id: "email", type: "email", placeholder: $.pandalocker.lang.errors_empty_email, req: !0 }]))
                    : "name-email-form" === this.options.type &&
                    ((this.advancedValidation = !0),
                        (this.options.fields = [
                            { id: "fullname", type: "text", placeholder: $.pandalocker.lang.misc_enter_your_name, req: !0 },
                            { id: "email", type: "email", placeholder: $.pandalocker.lang.misc_enter_your_email, req: !0 },
                        ]));
        }),
        (form._memorize = function (a, b) {
            ...
            if (localStorage && localStorage.setItem)
                try {
                    ...
                    $.pandalocker.tools.cookie(c, b, { expires: 365, path: "/" });
                }
            else $.pandalocker.tools.cookie(c, b, { expires: 365, path: "/" });
        }),
            ...
            if (this.options.preview)
                return (
                    console.log(this.getValues()),
                        void this.showNotice((window.bizpanda && window.bizpanda.res && window.bizpanda.res["subscription-preview-mode"]) || "The locker is in the preview mode. The subscription does not work here.")
                );
        ...
        (form.validate = function () {
            ...
            return (
                $.each(b, function (b, d) {
                    a.advancedValidation &&
                    d._$input &&
                    d._$input.bind("change keyup blur", function () {
                        a.validateField(d);
                    }),
        ...
        (form.validateText = function (a, b) {
            ...
            return !a.req || (c && c.length)
                ? !0
                : ("fullname" === a.id ? (b = $.pandalocker.lang.errors_empty_name) : "email" === a.id && (b = $.pandalocker.lang.errors_empty_email), this.showValidationError(a, b ? b : $.pandalocker.lang.errors_empty_field), !1);
        }),
        ...
        (form.validateInteger = function (a) {
            ...
            return c || a.req
                ? ((c = parseInt(c)),
                    isNaN(c)
                        ? (this.showValidationError(a, "Please enter an integer number."), !1)
                        : a.min && c < a.min
                            ? (this.showValidationError(a, "Please enter a number greater than or equal to {0}.".replace("{0}", a.min)), !1)
                            : a.max && c > a.max
                                ? (this.showValidationError(a, "Please enter a number less than or equal to {0}.".replace("{0}", a.max)), !1)
                                : !0)
                : !0;
        }),
        ...
        (form.showValidationError = function (a, b) {
            ...
            if (this.advancedValidation) {
                ...
                (this._validationErrorShown = !0),
                    this.showNotice(b, function () {
        ...
        (form.render = function (a) {
            ...
            a.find("input").keypress(function (a) {
                ...
                (this.$button = this.renderSubmitButton(a)),
        ...
        (form.renderSubmitButton = function (a) {
            ...
            return (
                this.group.isFirst && f.addClass("onp-sl-button-primary"),
                    f.appendTo(e),
                    d.addClass("onp-sl-note").addClass("onp-sl-nospa"),
                    d.appendTo(e),
                    f.click(function () {
                        return b.submit(), !1;
                    }),
        ...
        (form.renderText = function (a, b, c, d) {
            if (b.icon) {
                ...
                if ("none" !== e) {
                    ...
                    f.addClass("right" === e ? "onp-sl-icon-append" : "onp-sl-icon-prepend"), f.appendTo(a);
                }
            }
...
!(function (a) {
    "use strict";
    a.fn.pandalocker ||
    (a.pandalocker.widget("pandalocker", {
        options: {},
        _isLocked: !1,
        _defaults: {
            text: { header: null, message: null },
            theme: { name: "starter" },
            lang: "en_US",
            groups: { order: ["social-buttons"], union: "or" },
            terms: !1,
            privacyPolicy: !1,
            termsPopup: !1,
            connectButtons: {},
            socialButtons: {},
            overlap: { mode: "full", position: "middle", intensity: 5, altMode: "transparence" },
            cssClass: null,
            demo: !1,
            highlight: !0,
            googleAnalytics: !1,
            locker: { off: !1, stepByStep: !1, close: !1, timer: 0, mobile: !0, expires: !1, useCookies: !1, scope: !1, loadingTimeout: 1e3, tumbler: !0, tumblerInterval: 500, naMode: "show-error", visibility: [] },
        ...
        _prepareOptions: function () {
            ...
            (c = this.applyFilters("filter-default-options", c)),
            this.options.theme && !a.isPlainObject(this.options.theme) && (this.options.theme = { name: b.options.theme }),
            "object" != typeof this.options.theme && (this.options.theme = { name: b.options.theme });
            ...
            a.isArray(e.groups) && (e.groups = a.extend(!0, {}, c.groups, { order: e.groups })),
                (e.locker.timer = parseInt(e.locker.timer)),
            0 === e.locker.timer && (e.locker.timer = null),
                (this.options = this.applyFilters("filter-options", e)),
            "blurring" !== this.options.overlap.mode || a.pandalocker.tools.supportBlurring() || (this.options.overlap.mode = this.options.overlap.altMode);
        },
        _setupVariables: function () {
            if (
                ...
                this.options.groups.order.length > 0)
            )
        ...
        _initGroups: function () {
            ...
            for (var b = 0; b < this.options.groups.order.length; b++) {
                var c = this.options.groups.order[b],
                    ...
                    e = this.options[d] || {};
                if ((0 == b && (e.text = this.options.text), !a.pandalocker.groups[c])) return void this._showError("core", 'The control group "' + c + '" not found.');
        ...
        requestState: function (a) {
            var b = this,
                c = function (a) {
                    for (var c = b._groups.length, d = "locked", e = 0; e < b._groups.length; e++)
                        b._groups[e].requestState(function (b) {
        ...
        _showScreen: function (b, c) {
            ...
            var d = this;
            if (((this._currentScreenName = b), this.innerWrap.find(".onp-sl-screen").hide(), this.screens[b])) return this.screens[b].show(), void d.runHook("size-changed");
            var e = a("<div class='onp-sl-screen onp-sl-non-default-screen onp-sl-screen-" + b + "'></div>")
                .appendTo(this.innerWrap)
                .hide();
            (this.screens[b] = this._screenFactory[b](e, c)),
        ...
        _initScreens: function () {
            ...
            (this._currentScreenName = "default"),
                this._registerScreen("enter-email", function (b, c) {
                    ...
                    b.append(g);
                    var h = {};
                    (h.email = { name: "email", type: "text", placeholder: a.pandalocker.lang.misc_enter_your_email }), (h.submit = { name: "submit", type: "submit", title: c.buttonTitle });
                    for (var i in h) {
                        var j = h[i].type,
                            k = h[i].title,
                            ...
                            m = a("<div></div>")
                                ...
                                .addClass("onp-sl-field-" + i)
                                .addClass("onp-sl-field-type-" + j);
                        if ("text" === j || "email" === j) {
                    ...
                    b.find(".onp-sl-submit").click(function () {
                        ...
                        return e && e.length ? (a.pandalocker.tools.isValidEmailAddress(e) ? void (c.callback && c.callback(e)) : void d(a.pandalocker.lang.errors_inorrect_email)) : void d(a.pandalocker.lang.errors_empty_email);
                    });
                }),
                ...
                this._registerScreen("email-confirmation", function (c, d) {
                    ...
                    if (
                        (l[1].indexOf("gmail") >= 0
                            ? (m = { url: "https://mail.google.com/mail/?tab=wm", icon: "0px 0px", title: "Gmail" })
                            : l[1].indexOf("yahoo") >= 0
                                ? (m = { url: "https://mail.yahoo.com/", icon: "0px -70px", title: "Yahoo!" })
                                : l[1].indexOf("hotmail") >= 0
                                    ? (m = { url: "https://hotmail.com/", icon: " 0px -140px", title: "Hotmail" })
                                    : l[1].indexOf("outlook") >= 0 && (m = { url: "http://www.outlook.com/", icon: " 0px -140px", title: "Outlook" }),
                            m)
                    ) {
        ...
        _lock: function () {
            ...
            (this._markupIsCreated || this._createMarkup(),
                this.overlap
                    ? (this.overlapLockerBox.fadeIn(1e3, function () {
                        a._updateLockerPosition();
                    }),
                        a._updateLockerPosition())
                    : (this.element.hide(), this.locker.fadeIn(1e3)),
                (this._isLocked = !0),
                this.runHook("lock"),
                this.runHook("locked"),
                setTimeout(function () {
        ...
        _createMarkup: function () {
            ...
            (this.locker = a("<div class='onp-sl onp-sl-" + d + "'></div>")),
                (this.outerWrap = a("<div class='onp-sl-outer-wrap'></div>").appendTo(this.locker)),
                (this.innerWrap = a("<div class='onp-sl-inner-wrap'></div>").appendTo(this.outerWrap));
            var e = a("<div class='onp-sl-screen onp-sl-screen-default'></div>").appendTo(this.innerWrap);
            (this.screens["default"] = this.defaultScreen = e),
                ...
                this.locker.addClass(1 === this.options.groups.order.length ? "onp-sl-contains-single-group" : "onp-sl-contains-many-groups");
            for (var f = 0; f < this.options.groups.order.length; f++) this.locker.addClass("onp-sl-" + this.options.groups.order[f] + "-enabled");
            if ((this.locker.addClass(a.pandalocker.isTouch() ? "onp-sl-touch" : "onp-sl-no-touch"), this.options.cssClass && this.locker.addClass(this.options.cssClass), this.overlap)) {
                ...
                if (1 === k.length && "absolute" === k.css("position")) {
                    ...
                    l ||
                    (h.css({ position: "absolute", width: "100%", height: "100%", top: k.css("top"), left: k.css("left"), right: k.css("right"), bottom: k.css("bottom"), margin: k.css("margin") }),
                        k.css({ top: 0, left: 0, right: 0, bottom: 0, margin: "auto" }));
                }
                (this.overlapLockerBox = a("<div class='onp-sl-overlap-locker-box'></div>").hide()),
                    this.overlapLockerBox.addClass("onp-sl-position-" + this.options.overlap.position),
                    this.overlapLockerBox.append(this.locker),
                    (this.overlapBox = a("<div class='onp-sl-overlap-box'></div>")),
                ...
                if ((this.overlapBox.append(m), h.append(this.overlapBox), (this.containerToTrackSize = h), "blurring" === this.overlap)) {
                    ...
                    (this.blurArea = this.blurArea.Vague({ intensity: n, forceSVGUrl: !1 })), this.blurArea.blur();
                }
                ...
                "scroll" === this.options.overlap.position &&
            ...
            this._isLockerVisible || (this.options.lazy = !0);
            for (var o = 0; o < this._groups.length; o++) this._groups[o].renderGroup(e);
            (this.options.terms || this.options.privacyPolicy) && this._createTerms(), this.options.locker.close && this._createClosingCross(), this.options.locker.timer && this._createTimer();
        },
        ...
        _updateLockerPosition: function () {
            if (this.overlap) {
                var a = this.containerToTrackSize.outerHeight();
                "undefined" == typeof this.contentMinTopMargin && (this.contentMinTopMargin = parseInt(this.containerToTrackSize.css("marginTop"))),
                "undefined" == typeof this.contentMinBottomMargin && (this.contentMinBottomMargin = parseInt(this.containerToTrackSize.css("marginBottom")));
                var b = this.locker.outerHeight();
                if (b > a) {
                    var c = parseInt((b - a) / 2) + 20,
                        d = this.contentMinTopMargin < c ? c : this.contentMinTopMargin,
                        e = this.contentMinBottomMargin < c ? c : this.contentMinBottomMargin;
                    this.containerToTrackSize.css({ marginTop: d + "px", marginBottom: e + "px" });
                }
                if ("top" === this.options.overlap.position || "scroll" === this.options.overlap.position) {
                    var f = this.overlapBox.outerWidth(),
                        g = this.locker.outerWidth(),
                        h = this.overlapBox.outerHeight(),
                        i = this.options.overlap.offset;
                    if (!i) {
                        var i = Math.floor((f - g) / 2);
                        10 >= i && (i = 10);
                    }
                    if (2 * i + b > h) var i = Math.floor((h - b) / 2);
                    this.overlapLockerBox.css("marginTop", i + "px"), "scroll" === this.options.overlap.position && ((this._baseOffset = i), this._updateLockerPositionOnScrolling());
                }
                return "middle" === this.options.overlap.position ? void this.overlapLockerBox.css("marginTop", "-" + Math.floor(this.overlapLockerBox.innerHeight() / 2) + "px") : void 0;
            }
        },
        _updateLockerPositionOnScrolling: function () {
            var b = this.overlapBox.offset(),
                c = b.top,
                d = b.left,
                e = b.top + this.overlapBox.outerHeight(),
                f = this.overlapBox.outerWidth(),
                g = this.overlapBox.outerHeight(),
                h = this.locker.outerHeight();
            if (!(2 * this._baseBoxOffset + h + 10 >= g)) {
                var i = a(document).scrollTop(),
                    j = 20;
                return i + h + 2 * this._baseOffset + j > e
                    ? void this.overlapLockerBox
        ...
        _startTrackVisability: function () {
            var b = this,
                c = this.locker[0];
            c.getBoundingClientRect || this.runHook("raw-impress");
            var d = a(window).height(),
                e = a(window).width(),
                f = function () {
                    if (!c) return void b._stopTrackVisability();
            ...
            a(window).bind("resize.visability.opanda", function () {
                (d = a(window).height()), (e = a(window).width());
            }),
                a(window).bind("resize.visability.opanda scroll.visability.opanda", function () {
                    f();
                }),
            this._isLockerVisible ||
            (a("a, button")
                .add(a(document))
                .bind("click.visability.opanda", function () {
                    setTimeout(function () {
                        f();
                    }, 200);
                }),
                this.addHook("raw-impress", function () {
                    (b._isLockerVisible = !0), a("a, button").add(a(document)).unbind("click.visability.opanda");
                })),
                f();
        },
        _stopTrackVisability: function () {
            a(window).unbind(".visability.opanda");
        },
        _createClosingCross: function () {
            var b = this;
            a("<div class='onp-sl-cross' title='" + a.pandalocker.lang.misc_close + "' />")
        ...
        _createTimer: function () {
            ...
            (b = b.replace("{timer}", a("<span class='onp-sl-timer-counter'>" + this.options.locker.timer + "</span>")[0].outerHTML)),
                (this.timerLabel = a("<span class='onp-sl-timer-label'></span>").html(b).appendTo(this.timer)),
        ...
        _createTerms: function () {
            ...
            var b = a.pandalocker.lang.misc_your_agree_with,
                c = "";
            if (
                (this.options.terms && (c = a("<a target='_black' class='onp-sl-link'>" + a.pandalocker.lang.misc_terms_of_use + "</a>").attr("href", this.options.terms)[0].outerHTML),
                this.options.privacyPolicy &&
                (this.options.terms && (c += ", "), (c += a("<a target='_black' class='onp-sl-link'>" + a.pandalocker.lang.misc_privacy_policy + "</a>").attr("href", this.options.privacyPolicy)[0].outerHTML)),
                c && (b = b.replace("{links}", c)),
                    this.termsInnerWrap.html(b),
                    this.options.termsPopup)
            ) {
        ...
        _showContent: function (b) {
            ...
            var d = function () {
                ...
                c.locker && c.locker.hide(),
                    b
                        ? c.element.fadeIn(1e3, function () {
                            c.options.highlight && c.element.effect && c.element.effect("highlight", { color: "#fffbcc" }, 800);
                        })
                        : c.element.show(),
                    c.runHook("after-show-content");
            };
...
(function ($) {
    ...
    window.bizpanda.createInlineLockers = function ($holder) {
        ...
        for (var n = 0; n < $elements.length; n++) {
            ...
            var data = window.bizpanda.lockerOptions[lockId] ? window.bizpanda.lockerOptions[lockId] : $.parseJSON($target.next().text());
    ...
    window.bizpanda.createLocker = function ($target, data, lockId, mine) {
        ...
        var getContextData = function () {
            ...
            context.postTitle = document.getElementsByTagName("title")[0] ? document.getElementsByTagName("title")[0].innerHTML : "(no title)";
        ...
        if (typeof data.stats == "undefined" || data.stats) {
            ...
            var hooksToTrack = ["impress", "error", "social-app-declined", "got-linkedin-follower", "got-youtube-subscriber"];
