...
$var( function() {
    ...
    $var("#wcmamtx_reset_order_button").on('click',function() {
        ...
        if (result == true) {
            ...
            $var.ajax({
                data: {action: "restore_my_account_order" },
                type: 'POST',
                url: ajaxurl,
                success: function( response ) { 
                     window.location.reload();
    ...
    $var(".wcmamtx_new_order").on("click",function(event) {
               
        event.preventDefault();

        var evalue = $var("#wcmamtx_order_label").val();
        ...
        if (evalue == "") {
            ...
            $var.ajax({
                data: {
                    action    : "wcmamtxadmin_add_new_order",
                    new_row   : wcmamtx_sanitize(evalue),
                    security  : wcmamtxadmin.nonce,
                    nonce     : $var('#wcmamtx_hidden_order_type').attr("nonce")
    ...
    $var(".wcmamtx_new_actions").on("click",function(event) {
               
        event.preventDefault();

        var evalue = $var("#wcmamtx_actions_label").val();
        ...
        if (evalue == "") {
            ...
            var replacetxt = ''+wcmamtxadmin.wait_text+'';
            $var('.wcmamtx_new_actions').text(replacetxt);
            ...
            $var.ajax({
                data: {
                    action    : "wcmamtxadmin_add_new_actions",
                    new_row   : wcmamtx_sanitize(evalue),
                    security  : wcmamtxadmin.nonce,
                    nonce     : $var('#wcmamtx_hidden_order_type').attr("nonce")
