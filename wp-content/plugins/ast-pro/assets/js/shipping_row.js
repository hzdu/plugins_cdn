					...
					var option = {
						...
						success:function(data){								
							...
							if(progress == 100){
								...
								if(invalid_product_sku_error_class > 0){
									jQuery(".csv_error_details_ul").append('<li>'+invalid_product_sku_error_class+' tracking numbers import failed due to invalid product sku</li>');	
								}	
