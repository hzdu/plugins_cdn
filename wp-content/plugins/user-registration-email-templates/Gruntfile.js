module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			admin: {
				files: {
					"<%= dirs.css %>/user-regsitration-email-templates-admin.css":
						[
							"<%= dirs.css %>/select2.css",
							"<%= dirs.css %>/user-regsitration-email-templates-admin.css",
						],
					"<%= dirs.css %>/user-regsitration-email-templates-admin-rtl.css":
						[
							"<%= dirs.css %>/select2.css",
							"<%= dirs.css %>/user-regsitration-email-templates-admin-rtl.css",
						],
		...
		compress: {
			options: {
				archive: "user-registration-email-templates.zip",
			},
			files: {
				src: [
					"**",
				...
				dest: "user-registration-email-templates",
				expand: true,
			},
		},
	});
