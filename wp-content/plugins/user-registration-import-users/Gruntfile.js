...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ["<%= dirs.js %>/admin/*.js", "!<%= dirs.js %>/admin/*.min.js"],
        tasks: ["jshint", "uglify"],
      },
    },
    ...
    compress: {
      options: {
        archive: "user-registration-import-users.zip",
      },
      files: {
        src: [
          "**",
        ...
        dest: "user-registration-import-users",
        expand: true,
      },
    },
  });
  ...
  grunt.registerTask("js", ["uglify:admin"]);
