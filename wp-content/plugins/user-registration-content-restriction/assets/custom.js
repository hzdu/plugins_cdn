jQuery(document).ready(function () {
	...
	jQuery(function () {
		...
		if (mySelect == "1") {
			jQuery(".urcr_content_restriction_allow_access_to_roles").show();
		} else {
			jQuery(".urcr_content_restriction_allow_access_to_roles").hide();
		}
		...
		jQuery("body").on(
			...
			function () {
				if (jQuery(this).find("option:selected").val() == "1") {
					jQuery(
						".urcr_content_restriction_allow_access_to_roles"
					).show();
				} else {
					jQuery(
						".urcr_content_restriction_allow_access_to_roles"
