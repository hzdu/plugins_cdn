...
*/
(function(T,U,B){(function(M){"function"===typeof define&&define.amd?define(["jquery"],M):"object"===typeof module&&module.exports?module.exports=function(R,P){void 0===P&&(P="undefined"!==typeof B?require("jquery"):require("jquery")(R));M(P);return P}:M(T)})(function(M){var R=function(){if(M&&M.fn&&M.fn.asp_select2&&M.fn.asp_select2.amd)var t=M.fn.asp_select2.amd;(function(){if(!t||!t.requirejs){t?k=t:t={};var h,k,e;(function(c){function b(p,r){var w,D;r=r&&r.split("/");var E=z.map,J=E&&E["*"]||
{};if(p){p=p.split("/");var y=p.length-1;z.nodeIdCompat&&F.test(p[y])&&(p[y]=p[y].replace(F,""));"."===p[0].charAt(0)&&r&&(y=r.slice(0,r.length-1),p=y.concat(p));for(y=0;y<p.length;y++){var G=p[y];"."===G?(p.splice(y,1),--y):".."===G&&0!==y&&(1!==y||".."!==p[2])&&".."!==p[y-1]&&0<y&&(p.splice(y-1,2),y-=2)}p=p.join("/")}if((r||J)&&E){G=p.split("/");for(y=G.length;0<y;--y){var m=G.slice(0,y).join("/");if(r)for(D=r.length;0<D;--D)if(w=E[r.slice(0,D).join("/")])if(w=w[m]){var x=w;var v=y;break}if(x)break;
if(!C&&J&&J[m]){var C=J[m];var H=y}}!x&&C&&(x=C,v=H);x&&(G.splice(0,v,x),p=G.join("/"))}return p}function a(p,r){return function(){var w=K.call(arguments,0);"string"!==typeof w[0]&&1===w.length&&w.push(null);return q.apply(c,w.concat([p,r]))}}function d(p){return function(r){return b(r,p)}}function f(p){return function(r){u[p]=r}}function g(p){if(L.call(A,p)){var r=A[p];delete A[p];N[p]=!0;Q.apply(c,r)}if(!L.call(u,p)&&!L.call(N,p))throw Error("No "+p);return u[p]}function l(p){var r=p?p.indexOf("!"):
-1;if(-1<r){var w=p.substring(0,r);p=p.substring(r+1,p.length)}return[w,p]}function n(p){return function(){return z&&z.config&&z.config[p]||{}}}var q,u={},A={},z={},N={},L=Object.prototype.hasOwnProperty,K=[].slice,F=/\.js$/;var S=function(p,r){p=l(p);var w=p[0];r=r[1];p=p[1];if(w){w=b(w,r);var D=g(w)}w?p=D&&D.normalize?D.normalize(p,d(r)):b(p,r):(p=b(p,r),p=l(p),w=p[0],p=p[1],w&&(D=g(w)));return{f:w?w+"!"+p:p,n:p,pr:w,p:D}};var O={require:function(p){return a(p)},exports:function(p){var r=u[p];return"undefined"!==
typeof r?r:u[p]={}},module:function(p){return{id:p,uri:"",exports:u[p],config:n(p)}}};var Q=function(p,r,w,D){var E,J=[];var y=typeof w;var G=(D=D||p)?l(D):[];if("undefined"===y||"function"===y){r=!r.length&&w.length?["require","exports","module"]:r;for(E=0;E<r.length;E+=1){var m=S(r[E],G);y=m.f;if("require"===y)J[E]=O.require(p);else if("exports"===y){J[E]=O.exports(p);var x=!0}else if("module"===y)var v=J[E]=O.module(p);else if(L.call(u,y)||L.call(A,y)||L.call(N,y))J[E]=g(y);else if(m.p)m.p.load(m.n,
a(D,!0),f(y),{}),J[E]=u[y];else throw Error(p+" missing "+y);}r=w?w.apply(u[p],J):void 0;p&&(v&&v.exports!==c&&v.exports!==u[p]?u[p]=v.exports:r===c&&x||(u[p]=r))}else p&&(u[p]=w)};h=k=q=function(p,r,w,D,E){if("string"===typeof p)return O[p]?O[p](r):g(S(p,r?l(r):[]).f);if(!p.splice){z=p;z.deps&&q(z.deps,z.callback);if(!r)return;r.splice?(p=r,r=w,w=null):p=c}r=r||function(){};"function"===typeof w&&(w=D,D=E);D?Q(c,p,r,w):setTimeout(function(){Q(c,p,r,w)},4);return q};q.config=function(p){return q(p)};
h._defined=u;e=function(p,r,w){if("string"!==typeof p)throw Error("See almond README: incorrect module build, no module name");r.splice||(w=r,r=[]);L.call(u,p)||L.call(A,p)||(A[p]=[p,r,w])};e.amd={jQuery:!0}})();t.requirejs=h;t.require=k;t.define=e}})();t.define("almond",function(){});t.define("jquery",[],function(){var h=M||U;null==h&&console&&console.error&&console.error("asp_Select2: An instance of jQuery or a jQuery-compatible library was not found. Make sure that you are including jQuery before asp_Select2 on your web page.");
...
var a={role:"option","aria-selected":"false"},d=B.Element.prototype.matches||B.Element.prototype.msMatchesSelector||B.Element.prototype.webkitMatchesSelector;if(null!=c.element&&d.call(c.element,":disabled")||null==c.element&&c.disabled)delete a["aria-selected"],a["aria-disabled"]="true";null==c.id&&delete a["aria-selected"];null!=c._resultId&&(b.id=c._resultId);c.title&&(b.title=c.title);c.children&&(a.role="group",a["aria-label"]=c.text,delete a["aria-selected"]);for(var f in a)b.setAttribute(f,
...
b));this.ajaxOptions.delay&&null!=b.term?(this._queryTimeout&&B.clearTimeout(this._queryTimeout),this._queryTimeout=B.setTimeout(d,this.ajaxOptions.delay)):d()};return c});t.define("asp_select2/data/tags",["jquery"],function(h){function k(e,c,b){var a=b.get("tags"),d=b.get("createTag");void 0!==d&&(this.createTag=d);d=b.get("insertTag");void 0!==d&&(this.insertTag=d);e.call(this,c,b);if(Array.isArray(a))for(e=0;e<a.length;e++)c=this._normalizeItem(a[e]),c=this.option(c),this.$element.append(c)}k.prototype.query=
function(e,c,b){function a(f,g){for(var l=f.results,n=0;n<l.length;n++){var q=l[n],u=null!=q.children&&!a({results:q.children},!0);q=(q.text||"").toUpperCase();var A=(c.term||"").toUpperCase();if(q===A||u){if(g)return!1;f.data=l;b(f);return}}if(g)return!0;g=d.createTag(c);null!=g&&(n=d.option(g),n.attr("data-asp_select2-tag",!0),d.addOptions([n]),d.insertTag(l,g));f.results=l;b(f)}var d=this;this._removeOldTags();null==c.term||null!=c.page?e.call(this,c,b):e.call(this,c,a)};k.prototype.createTag=
...
this.$searchContainer=b;this.$search=b.find("input");c.prepend(b);return c};e.prototype.bind=function(c,b,a){var d=this,f=b.id+"-results";c.call(this,b,a);this.$search.on("keydown",function(g){d.trigger("keypress",g);d._keyUpPrevented=g.isDefaultPrevented()});this.$search.on("input",function(g){h(this).off("keyup")});this.$search.on("keyup input",function(g){d.handleSearch(g)});b.on("open",function(){d.$search.attr("tabindex",0);d.$search.attr("aria-controls",f);d.$search.trigger("focus");B.setTimeout(function(){d.$search.trigger("focus")},
...
function(h,k,e,c,b,a,d,f,g,l,n,q,u,A,z,N,L,K,F,S,O,Q,p,r,w,D,E,J,y){function G(){this.reset()}G.prototype.apply=function(m){m=h.extend(!0,{},this.defaults,m);if(null==m.dataAdapter){m.dataAdapter=null!=m.ajax?z:null!=m.data?A:u;0<m.minimumInputLength&&(m.dataAdapter=l.Decorate(m.dataAdapter,K));0<m.maximumInputLength&&(m.dataAdapter=l.Decorate(m.dataAdapter,F));0<m.maximumSelectionLength&&(m.dataAdapter=l.Decorate(m.dataAdapter,S));m.tags&&(m.dataAdapter=l.Decorate(m.dataAdapter,N));if(null!=m.tokenSeparators||
null!=m.tokenizer)m.dataAdapter=l.Decorate(m.dataAdapter,L);if(null!=m.query){var x=k(m.amdBase+"compat/query");m.dataAdapter=l.Decorate(m.dataAdapter,x)}null!=m.initSelection&&(x=k(m.amdBase+"compat/initSelection"),m.dataAdapter=l.Decorate(m.dataAdapter,x))}null==m.resultsAdapter&&(m.resultsAdapter=e,null!=m.ajax&&(m.resultsAdapter=l.Decorate(m.resultsAdapter,r)),null!=m.placeholder&&(m.resultsAdapter=l.Decorate(m.resultsAdapter,p)),m.selectOnClose&&(m.resultsAdapter=l.Decorate(m.resultsAdapter,
E)));if(null==m.dropdownAdapter){m.multiple?m.dropdownAdapter=O:(x=l.Decorate(O,Q),m.dropdownAdapter=x);0!==m.minimumResultsForSearch&&(m.dropdownAdapter=l.Decorate(m.dropdownAdapter,D));m.closeOnSelect&&(m.dropdownAdapter=l.Decorate(m.dropdownAdapter,J));if(null!=m.dropdownCssClass||null!=m.dropdownCss||null!=m.adaptDropdownCssClass)x=k(m.amdBase+"compat/dropdownCss"),m.dropdownAdapter=l.Decorate(m.dropdownAdapter,x);m.dropdownAdapter=l.Decorate(m.dropdownAdapter,w)}if(null==m.selectionAdapter){m.selectionAdapter=
...
x=[];for(var v=0;v<m.language.length;v++){var C=m.language[v];-1===x.indexOf(C)&&x.push(C)}m.language=x;m.translations=this._processTranslations(m.language,m.debug);return m};G.prototype.reset=function(){function m(v){return v.replace(/[^\u0000-\u007E]/g,function(C){return q[C]||C})}function x(v,C){if(""===String.prototype.trim.call(null==v.term?"":v.term))return C;if(C.children&&0<C.children.length){for(var H=h.extend(!0,{},C),I=C.children.length-1;0<=I;I--)null==x(v,C.children[I])&&H.children.splice(I,
1);return 0<H.children.length?H:x(v,H)}H=m(C.text).toUpperCase();v=m(v.term).toUpperCase();return-1<H.indexOf(v)?C:null}this.defaults={amdBase:"./",amdLanguageBase:"./i18n/",closeOnSelect:!0,debug:!1,dropdownAutoWidth:!1,escapeMarkup:l.escapeMarkup,language:{},matcher:x,minimumInputLength:0,maximumInputLength:0,maximumSelectionLength:0,minimumResultsForSearch:0,selectOnClose:!1,scrollAfterSelect:!1,sorter:function(v){return v},templateResult:function(v){return v.text},templateSelection:function(v){return v.text},
theme:"default",width:"resolve"}};G.prototype.applyFromElement=function(m,x){var v=m.language,C=this.defaults.language,H=x.prop("lang");x=x.closest("[lang]").prop("lang");v=Array.prototype.concat.call(this._resolveLanguage(H),this._resolveLanguage(v),this._resolveLanguage(C),this._resolveLanguage(x));m.language=v;return m};G.prototype._resolveLanguage=function(m){if(!m||h.isEmptyObject(m))return[];if(h.isPlainObject(m))return[m];m=Array.isArray(m)?m:[m];for(var x=[],v=0;v<m.length;v++)if(x.push(m[v]),
"string"===typeof m[v]&&0<m[v].indexOf("-")){var C=m[v].split("-")[0];x.push(C)}return x};G.prototype._processTranslations=function(m,x){for(var v=new n,C=0;C<m.length;C++){var H=new n,I=m[C];if("string"===typeof I)try{H=n.loadPath(I)}catch(V){try{I=this.defaults.amdLanguageBase+I,H=n.loadPath(I)}catch(W){x&&B.console&&console.warn&&console.warn('asp_Select2: The language file for "'+I+'" could not be automatically loaded. A fallback will be used instead.')}}else H=h.isPlainObject(I)?new n(I):I;v.extend(H)}return v};
G.prototype.set=function(m,x){m=h.camelCase(m);var v={};v[m]=x;x=l._convertData(v);h.extend(!0,this.defaults,x)};return new G});t.define("asp_select2/options",["require","jquery","./defaults","./utils"],function(h,k,e,c){function b(a,d){this.options=a;null!=d&&this.fromElement(d);null!=d&&(this.options=e.applyFromElement(this.options,d));this.options=e.apply(this.options);d&&d.is("input")&&(a=h(this.get("amdBase")+"compat/inputData"),this.options.dataAdapter=c.Decorate(this.options.dataAdapter,a))}
b.prototype.fromElement=function(a){function d(A,z){return z.toUpperCase()}var f=["asp_select2"];null==this.options.multiple&&(this.options.multiple=a.prop("multiple"));null==this.options.disabled&&(this.options.disabled=a.prop("disabled"));null==this.options.dir&&(a.prop("dir")?this.options.dir=a.prop("dir"):a.closest("[dir]").prop("dir")?this.options.dir=a.closest("[dir]").prop("dir"):this.options.dir="ltr");a.prop("disabled",this.options.disabled);a.prop("multiple",this.options.multiple);c.GetData(a[0],
"asp_select2Tags")&&(this.options.debug&&B.console&&console.warn&&console.warn('asp_Select2: The `data-asp_select2-tags` attribute has been changed to use the `data-data` and `data-tags="true"` attributes and will be removed in future versions of asp_Select2.'),c.StoreData(a[0],"data",c.GetData(a[0],"asp_select2Tags")),c.StoreData(a[0],"tags",!0));c.GetData(a[0],"ajaxUrl")&&(this.options.debug&&B.console&&console.warn&&console.warn("asp_Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` and support for the old attribute will be removed in future versions of asp_Select2."),
...
this._syncA);var d=B.MutationObserver||B.WebKitMutationObserver||B.MozMutationObserver;null!=d?(this._observer=new d(function(f){a._syncA();a._syncS(null,f)}),this._observer.observe(this.$element[0],{attributes:!0,childList:!0,subtree:!1})):this.$element[0].addEventListener&&(this.$element[0].addEventListener("DOMAttrModified",a._syncA,!1),this.$element[0].addEventListener("DOMNodeInserted",a._syncS,!1),this.$element[0].addEventListener("DOMNodeRemoved",a._syncS,!1))};b.prototype._registerDataEvents=
...
function(a){this.options.get("debug")&&B.console&&console.warn&&console.warn('asp_Select2: The `asp_select2("enable")` method has been deprecated and will be removed in later asp_Select2 versions. Use $element.prop("disabled") instead.');if(null==a||0===a.length)a=[!0];this.$element.prop("disabled",!a[0])};b.prototype.data=function(){this.options.get("debug")&&0<arguments.length&&B.console&&console.warn&&console.warn('asp_Select2: Data can no longer be set using `asp_select2("data")`. You should consider setting the value instead using `$element.val()`.');
var a=[];this.dataAdapter.current(function(d){a=d});return a};b.prototype.val=function(a){this.options.get("debug")&&B.console&&console.warn&&console.warn('asp_Select2: The `asp_select2("val")` method has been deprecated and will be removed in later asp_Select2 versions. Use $element.val() instead.');if(null==a||0===a.length)return this.$element.val();a=a[0];Array.isArray(a)&&(a=h.map(a,function(d){return d.toString()}));this.$element.val(a).trigger("input").trigger("change")};b.prototype.destroy=
...
"":e.term))return b;if(c.children){for(var a=c.children.length-1;0<=a;a--){var d=c.children[a];k(e.term,d.text,d)||b.children.splice(a,1)}if(0<b.children.length)return b}return k(e.term,c.text,c)?b:null}}});t.define("asp_select2/compat/query",[],function(){function h(k,e,c){c.get("debug")&&B.console&&console.warn&&console.warn("asp_Select2: The `query` option has been deprecated in favor of a custom data adapter that overrides the `query` method. Support will be removed for the `query` option in future versions of asp_Select2.");
...
function(b){b.stopPropagation()})};return h});(function(h){"function"===typeof t.define&&t.define.amd?t.define("jquery-mousewheel",["jquery"],h):"object"===typeof exports?module.exports=h:h(M)})(function(h){function k(n){var q=n||B.event,u=a.call(arguments,1),A=0,z=0,N=0,L=0;n=h.event.fix(q);n.type="mousewheel";"detail"in q&&(z=-1*q.detail);"wheelDelta"in q&&(z=q.wheelDelta);"wheelDeltaY"in q&&(z=q.wheelDeltaY);"wheelDeltaX"in q&&(A=-1*q.wheelDeltaX);"axis"in q&&q.axis===q.HORIZONTAL_AXIS&&(A=-1*
z,z=0);var K=0===z?A:z;"deltaY"in q&&(K=z=-1*q.deltaY);"deltaX"in q&&(A=q.deltaX,0===z&&(K=-1*A));if(0!==z||0!==A){if(1===q.deltaMode){var F=h.data(this,"mousewheel-line-height");K*=F;z*=F;A*=F}else 2===q.deltaMode&&(F=h.data(this,"mousewheel-page-height"),K*=F,z*=F,A*=F);F=Math.max(Math.abs(z),Math.abs(A));if(!f||F<f)f=F,l.settings.adjustOldDeltas&&"mousewheel"===q.type&&0===F%120&&(f/=40);l.settings.adjustOldDeltas&&"mousewheel"===q.type&&0===F%120&&(K/=40,A/=40,z/=40);K=Math[1<=K?"floor":"ceil"](K/
f);A=Math[1<=A?"floor":"ceil"](A/f);z=Math[1<=z?"floor":"ceil"](z/f);l.settings.normalizeOffset&&this.getBoundingClientRect&&(q=this.getBoundingClientRect(),N=n.clientX-q.left,L=n.clientY-q.top);n.deltaX=A;n.deltaY=z;n.deltaFactor=f;n.offsetX=N;n.offsetY=L;n.deltaMode=0;u.unshift(n,K,A,z);d&&clearTimeout(d);d=setTimeout(e,200);return(h.event.dispatch||h.event.handle).apply(this,u)}}function e(){f=null}var c=["wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"],b="onwheel"in document||9<=document.documentMode?
...
1);this.each(function(){var l=b.GetData(this,"asp_select2");null==l&&B.console&&console.error&&console.error("The asp_select2('"+d+"') method was called on an element that is not using asp_Select2.");f=l[d].apply(l,g)});return-1<h.inArray(d,a)?this:f}throw Error("Invalid arguments for asp_Select2: "+d);}}null==h.fn.asp_select2.defaults&&(h.fn.asp_select2.defaults=c);return e});return{define:t.define,require:t.require}}(),P=R.require("jquery.asp_select2");M.fn.asp_select2.amd=R;return P})})(aspjQuery,
aspjQuery,window);
