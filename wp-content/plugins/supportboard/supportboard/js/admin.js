        ...
        */
        ...
        $(document).on('SBMessageSent', function (e, response) {
            ...
            if (SBApps.whatsapp.check(conversation)) {
                SBApps.whatsapp.send(SBApps.whatsapp.activeUserPhone(user), response.message, response.attachments, (response) => {
            ...
            if (SB_ADMIN_SETTINGS['assign-conversation-to-agent'] && SBF.null(Sconversation.get('agent_id'))) {
