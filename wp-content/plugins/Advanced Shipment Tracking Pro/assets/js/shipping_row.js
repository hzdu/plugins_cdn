...
jQuery("#wc_ast_show_orders_actions,#wc_ast_unclude_tracking_info,#ast_order_display_in_fulfillment_dashboard,#ast_shipping_method_display_in_fulfillment_dashboard").on("change", function (e) { 
	save_ast_seetings();  
});
