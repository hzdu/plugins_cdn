...
var ischecked= jQuery("#woocommerce_square_woocommerce_square_enable_sandbox:checkbox").is(':checked');
...
function hide_unhide_squ_order_sync(){
var ischecked= jQuery("#squ_woo_order_sync:checkbox").is(':checked');
// console.log(ischecked);
if(ischecked){
    jQuery(".squ-order-sync-description").fadeIn();
    jQuery("#woocommerce_square_access_token").parents("tr").fadeIn();
    jQuery("#woocommerce_square_application_id").parents("tr").fadeIn();
    jQuery("#woocommerce_square_location_id").parents("tr").fadeIn();
} else {
	jQuery(".squ-order-sync-description").fadeOut();
	jQuery("#woocommerce_square_access_token").parents("tr").fadeOut();
	jQuery("#woocommerce_square_application_id").parents("tr").fadeOut();
    jQuery("#woocommerce_square_location_id").parents("tr").fadeOut();
}
...
jQuery( document ).ready(function() {
	...
	hide_unhide_squ_order_sync();
	
	jQuery("#woocommerce_square_woocommerce_square_enable_sandbox:checkbox").change(function() {
		hide_unhide_squ_sandbox();
		// console.log('hide_unhide_squ_sandbox');
	});
	
	jQuery("#squ_woo_order_sync:checkbox").change(function() {
		hide_unhide_squ_order_sync();
		// console.log('hide_unhide_squ_order_sync');
	});
});