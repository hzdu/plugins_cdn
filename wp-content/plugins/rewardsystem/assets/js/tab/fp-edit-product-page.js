...
jQuery( function ( $ ) {
    ...
    var EditProductPageScript = {
        init : function () {
            ...
            $( document ).on( 'change' , '#_srp_user_filter_type_for_pp' , this.toggle_user_filter_type ) ;
        ...
        show_or_hide_for_product_purchase_reward_points : function () {
            if ( jQuery( '#_rewardsystemcheckboxvalue' ).val() == 'no' ) {
                ...
                jQuery( '.srp-user-role-filter-field' ).css( 'display' , 'none' ) ;
                jQuery( '#_srp_user_filter_for_pp' ).closest('p').css( 'display' , 'none' ) ;
            } else {
                ...
                EditProductPageScript.toggle_user_filter_type();

            }
        } ,
        toggle_user_filter_type : function () {
            if ( jQuery( '._srp_user_filter_type_for_pp' ).val() === '1' ) {
                jQuery( '.srp-user-role-filter-field' ).css( 'display' , 'block' ) ;
                jQuery( '#_srp_user_filter_for_pp' ).closest('p').css( 'display' , 'none' ) ;
            } else {
                jQuery( '.srp-user-role-filter-field' ).css( 'display' , 'none' ) ;
                jQuery( '#_srp_user_filter_for_pp' ).closest('p').css( 'display' , 'block' ) ;
            }
        },
