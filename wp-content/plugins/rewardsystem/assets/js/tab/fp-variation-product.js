...
jQuery( function ( $ ) {
    ...
    var RSVariableProductValidation = {
        init : function () {
            ...
            $( document ).on( 'change' , '.srp-user-filter-type' , this.toggle_srp_user_filter_type ) ;
        ...
        enable_disable_reward_points( enable_reward ) {
            if ( '1' === $(enable_reward).val() ){
                ...
                RSVariableProductValidation.show_or_hide_for_user_filter( $(enable_reward).closest('div').find('.srp-user-filter-type') );
            } else {
        ...
        toggle_srp_user_filter_type(e){
            e.preventDefault();
            RSVariableProductValidation.show_or_hide_for_user_filter(this) ;
        },

        show_or_hide_for_user_filter(reward_type){
            if ( '1' === $(reward_type).val()){
                $(reward_type).closest('div').find('.srp-user-role-filter-field').show();
                $(reward_type).closest('div').find('.srp-user-filter-field').hide();
            } else {
                $(reward_type).closest('div').find('.srp-user-role-filter-field').hide();
                $(reward_type).closest('div').find('.srp-user-filter-field').show();
            }
        },
