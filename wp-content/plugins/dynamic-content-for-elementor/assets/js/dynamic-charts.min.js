...
options={responsive:!0,maintainAspectRatio:!1,};scales={scales:{y:{beginAtZero:Boolean(elementSettings.begin_at_zero),grace:elementSettings.grace?elementSettings.grace:0,}},};if('line'===elementSettings.type||'bar'===elementSettings.type){$.extend(options,scales)}
new Chart(ctx,{type:elementSettings.type,data:{labels:labels,datasets:[{label:elementSettings.legend,data:data,backgroundColor:backgroundColors,borderColor:borderColors,borderWidth:elementSettings.border_width_data?elementSettings.border_width_data:0,}]},options:options,})};$(window).on('elementor/frontend/init',function(){elementorFrontend.hooks.addAction('frontend/element_ready/dce-dynamic-charts.default',WidgetElements_DynamicCharts)})})(jQuery)