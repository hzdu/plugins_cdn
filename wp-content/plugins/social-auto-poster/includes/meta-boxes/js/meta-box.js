  ...
  */
  ...
  var formfield1;
    ...
    if(typeof wp == "undefined" || WpwAutoPosterMeta.new_media_ui != '1' ){// check for media uploader//
      ...
      if( button.attr('rel') == '_wpweb_yt_post_image' ){
      ...
      file_frame.on( 'insert', function() {
        ...
        selection.each( function( attachment, index ) {
          ...
          if( ( attachment.type == 'image' && button.attr('rel') != '_wpweb_yt_post_image' ) || ( attachment.type == 'video' && button.attr('rel') == '_wpweb_yt_post_image' )  ) {
              if(index == 0){
                // place first attachment in field
