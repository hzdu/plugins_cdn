				...
				if ( settings['showPagination'] ) {
					if ( 'thumbnails' === paginationType ) {
						...
						let thumbnailsSliderItemsCount = thumbnails.find( '.jet-woo-swiper-control-thumbs__item' ).length,
							currentDeviceSlidePerView = window.elementorFrontend ? +widgetSettings[ 'pagination_thumbnails_columns_' + window.elementorFrontend.getCurrentDeviceMode() ] : +widgetSettings['pagination_thumbnails_columns'];
