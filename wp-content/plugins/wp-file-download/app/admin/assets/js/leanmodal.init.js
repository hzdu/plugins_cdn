...
jQuery(document).ready(function ($) {
    ...
    $('body').append('<div id="wpfdmodal"><img alt="Loading..." src="images/spinner-2x.gif" width="32" id="wpfd_loader" /><iframe id="wpfdmodalframe" onload="wpfd_frameload()"  width="100%" height="100%" marginWidth="0" marginHeight="0" frameBorder="0" scrolling="auto" data-src="admin.php?page=wpfd&noheader=1&caninsert=1"></iframe><button id="wpfd-close-modal">x</button></div>');
